<template>
    <div class='modal fade text-left' id='cancellation'>
                ...
                <div class='modal-body'>
                    ...
                    <form @submit.prevent="submit" method='POST'>
                        ...
                        <div class='form-group'>
                            ...
                            <input type='text' name='reason' id='reason' v-model="form.reason" class='form-control' placeholder='Enter Reason for Cancellation' required>
                        </div>
                        <div class='form-group'>
...
export default {
    ...
    methods: {
        ...
        submit() {
            ...
            this.$store.dispatch('CANCEL_RESTAURANT_ORDER', this.form)
            .then(response => {
                this.$toast.open({
