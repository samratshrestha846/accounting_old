                                    ...
                                    <tr v-if="orderitems && orderitems.length > 0" v-for="item in orderitems">
                                        ...
                                        <td style="width: 120px;">
                                            <div class="btn-bulk justify-content-center">
                                                ...
                                                <!-- <button v-if="!(item.status == 0 || item.status == 4)" class="btn btn-secondary icon-btn btn-sm" title="Cancle Order"  @click="actionCancleOrder(item.id)">
                                                    <i class="fa fa-ban"></i>
                                                </button> -->
                                                <button v-if="!(item.status == 0 || item.status == 4)"  class="btn btn-primary icon-btn btn-sm" title="Suspend Order"  @click="actionSuspendOrder(item.id)">
                                                    <i class="fas fa-sync"></i>
                                                </button>
                                                <a v-if="item.status == 0 || item.status == 4" href="javascript:void(0)" class='btn btn-primary icon-btn btn-sm text-light ml-1' title="Restored" @click="actionRestoreSuspendedOrderItem(item.id    )">
...
export default {
    ...
    methods: {
        ...
        actionRestoreSuspendedOrderItem(order_id) {
            ...
            this.$swal.fire({
                title: "Are you sure you want to restore order item?",
                ...
                if (result.isConfirmed) {
                    ...
                    .then(response => {
                        ...
                        this.$emit('decrementTotalSuspended'); //increment the totalsuspended count
                        this.$emit('incrementTotalPending'); //decrement the  totalpending count
                    })
                    .catch(error => {
                        this.$toast.open({
