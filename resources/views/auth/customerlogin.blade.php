...
@section('content')
    <a href="{{route('login')}}" class="btn btn-primary top-btn">Login for Organization</a>
    <div class="card card-outline" style="box-shadow: 0px 1px 5px rgb(0 0 0 / 15%);border:none;">
        ...
        <div class="card-body" style="background:#f7f7f7;border-bottom-left-radius: 4px;border-bottom-right-radius: 4px;">
            ...
            <form method="POST" action="{{ route('signInCustomer') }}">
                @csrf
                <div class="input-group mb-3">
                    <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email"
                        value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="Email" style="height: 40px;">
                ...
                <div class="input-group mb-3">
                    <input id="password" type="password" class="form-control @error('password') is-invalid @enderror"
                        name="password" required autocomplete="current-password" placeholder="Password" style="height: 40px;">
                    <div class="input-group-append">
                        <div class="input-group-text">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="icheck-primary" style="display: flex;align-items:center;justify-content:space-between;margin-bottom:20px !important;">
                            <div class="chk">
                                <input class="form-check-input" style="margin-left:0;" type="checkbox" name="remember" id="remember_me"
