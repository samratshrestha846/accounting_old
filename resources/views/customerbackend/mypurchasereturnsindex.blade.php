        ...
        <div class="container-fluid">
            <div class="sec-header">
                <div class="sec-header-wrap">
                    <h1>My Purchase Returns</h1>
                    @php
                        $allsales = [];
                        $totalpaid = [];
                        foreach ($purchasereturns as $salesBilling) {
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered data-table text-center">
                                            ...
                                            <tbody>
                                                @forelse ($purchasereturns as $purchase)
                                                @php
                                                    $paid_amount = [];
                                        ...
                                        <div class="mt-3">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <p class="text-sm">
                                                        Showing
                                                        <strong>{{ $purchasereturns->firstItem() }}</strong>
                                                        to
                                                        <strong>{{ $purchasereturns->lastItem() }} </strong> of
                                                        <strong>
                                                            {{ $purchasereturns->total() }}</strong>
                                                        entries
                                                        <span> | Takes
                                                ...
                                                <div class="col-md-6">
                                                    <span
                                                        class="pagination-sm m-0 float-right">{{ $purchasereturns->links() }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
