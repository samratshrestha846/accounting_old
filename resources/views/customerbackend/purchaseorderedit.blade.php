            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="ibox card">
                            <div class="ibox-body">
                                <form action="{{route('clientpurchaseorder.update', $clientOrder->id)}}" method="POST">
                                    @csrf
                                    @method("PUT")
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="fiscal_year" id="fiscal-year" class="form-control">
                                                    @foreach ($fiscal_years as $fiscalyear)
                                                        <option value="{{ $fiscalyear->id }}" {{$fiscalyear->id == $clientOrder->fiscal_year_id ? 'selected':''}}>{{ $fiscalyear->fiscal_year }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                <p class="text-danger">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="nep_date" id="entry_date_nepali"
                                                            class="form-control" value="{{ $clientOrder->nep_date }}" readonly="readonly">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" name="eng_date" id="english" class="form-control"
                                                            value="{{ $clientOrder->eng_date }}" readonly="readonly">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                                        ...
                                                        <tr class="item-row">
                                                            <td>
                                                                <div class="delete-btn">
                                                                    <input type="text" name="particulars[]" class="form-control item" placeholder="Enter Product Name" value="{{$extra->particulars}}">
                                                                    <p class="text-danger">
                                                            ...
                                                            <td>
                                                                <input class="form-control qty" placeholder="Quantity" type="number"
                                                                    name="quantity[]" value="{{$extra->quantity}}">
                                                                <p class="text-danger">
                                                            ...
                                                            <td>
                                                                <select name="unit[]" class="form-control unit">
                                                                    @foreach ($units as $unit)
                                                                        <option value="{{$unit->unit}}" {{$unit->unit == $extra->unit ? "selected" : ''}}>{{$unit->unit}}({{$unit->short_form}})</option>
                                                                    @endforeach
                                                                </select>
                                                                <p class="text-danger">
                                                                    {{ $errors->first('unit') }}
                                        ...
                                        <div class="col-md-12 mt-3">
                                            <div class="form-gorup">
                                                ...
                                                <textarea name="remarks" class="form-control" placeholder="Remarks.." cols="10" rows="5">{{$clientOrder->remarks}}</textarea>
                                                <p class="text-danger">
