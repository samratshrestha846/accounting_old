        ...
        <div class="sec-header">
            <div class="container-fluid">
                <div class="sec-header-wrap">
                    <h1>Staff </h1>
                    <div class="btn-bulk">
                        <a href="{{ route('hospital-staff.create') }}" class="global-btn">Add New staff</a>
                    </div>
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
                                    ...
                                    <tbody>
                                        @forelse ($staffs as $key=>$staff)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-bulk">
                                                        <a href='{{ route('hospital-staff.edit', $staff->id) }}'
                                                            class='edit btn btn-primary icon-btn btn-sm' title='Edit'><i
                                                                class='fa fa-edit'></i></a>
                                                        @include('lab.includes._modal',['id'=>$staff->id,'route'=>route('hospital-staff.destroy',$staff->id)])
                                                    </div>
                                                </td>
                                            </tr>
                                        @empty
