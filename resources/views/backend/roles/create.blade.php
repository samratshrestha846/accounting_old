        ...
        <div class="sec-header">
            <div class="container-fluid">
                <div class="sec-header-wrap">
                    ...
                    <div class="btn-bulk">
                        <a href="{{ route('roles.index') }}" class="global-btn">View
                            Roles</a>
                    </div>
                    <!-- /.col -->
                </div><!-- /.row -->
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group" style="display: flex;margin-bottom:0;">
                                        <label for="name" style="white-space: nowrap;margin-right:10px;align-items:center;margin-bottom:0;">Role Name<i class="text-danger">*</i>: </label>
