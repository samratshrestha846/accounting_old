        ...
        <div class="sec-header">
            <div class="container-fluid">
                <div class="sec-header-wrap">
                    <h1>Search Roles </h1>
                    <div class="btn-bulk">
                        <a href="{{ route('roles.create') }}" class="global-btn">Create
                            Role</a>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                                            ...
                                            <td style="width: 120px;">
                                                <div class="btn-bulk justify-content-center">
                                                    ...
                                                    $btn = "<a href='$editurl' class='edit btn btn-primary icon-btn btn-sm' title='Edit'><i class='fa fa-edit'></i></a>
                                                                                                                                                                                                                                                                            <button type='button' class='btn btn-secondary icon-btn btn-sm' data-toggle='modal' data-target='#deleterole$role->id' data-toggle='tooltip' data-placement='top' title='Delete'><i class='fa fa-trash'></i></button>
                                                                                                                                                                                                                                                                            <!-- Modal -->
                                                                                                                                                                                                                                                                                <div class='modal fade text-left' id='deleterole$role->id' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel' aria-hidden='true'>
