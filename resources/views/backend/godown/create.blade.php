        ...
        <div class="sec-header">
            <div class="container-fluid">
                <div class="sec-header-wrap">
                        <h1>New Godown Information </h1>
                        <div class="btn-bulk">
                            <a href="{{ route('godown.index') }}"
                                class="global-btn">View Godowns</a>
                        </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="row align-items-end">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="godown_name" class="form-control"
                                            placeholder="Godown Name" value="{{ old('godown_name') }}">
                                        <p class="text-danger">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="godown_code" id="godown_code" class="form-control"
                                            placeholder="Godown Name" value="{{ old('godown_code', $godown_code) }}">
                                        <p class="text-danger godowncode_error hide">Code is already used. Use Different
                                            code.</p>
                                        <p class="text-danger">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="local_address" class="form-control"
                                            placeholder="Eg: Chamti tole" value="{{ old('local_address') }}">
                                        <p class="text-danger">
...
@push('scripts')
    <script>
        $(function() {
            ...
            var godowncodes = @php echo json_encode($allgodowncodes) @endphp;
            $("#godown_code").change(function() {
                var productcategoryval = $(this).val();
                if ($.inArray(productcategoryval, godowncodes) != -1) {
                    $('.godowncode_error').addClass('show');
                    $('.godowncode_error').removeClass('hides');
                } else {
                    $('.godowncode_error').removeClass('show');
                    $('.godowncode_error').addClass('hide');
                }
            })
        });
    </script>
