    ...
    <div class="sec-header">
      <div class="container-fluid">
        <div class="sec-header-wrap">
              ...
              <h1 class="m-0">Search Materialized {{$billingtype->billing_types}} View </h1>
                @else
                @php
            ...
            //   dd($url);
              @endphp
            <h1 class="m-0">Materialized {{$billingtype->billing_types}} View </h1>
              @endif
          <div class="btn-bulk">
            @if ($billingtype->slug == "debit-note" || $billingtype->slug == "credit-note")
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="m-0 float-right">
                            <form class="form-inline" action="{{route('billings.materializedsearch', $billingtype->id)}}" method="POST">
                                @csrf
