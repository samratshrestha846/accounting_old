        ...
        <div class="sec-header">
            <div class="container-fluid">
                <div class="sec-header-wrap">
                    <h1>{{ $billingtype->billing_types }} Register Bills </h1>
                    <div class="btn-bulk">
                        <a href="{{ route('billings.report', $billing_type_id) }}" class="global-btn">View
                            {{ $billingtype->billing_types }}</a>
                    </div>
                    <!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                ...
                <div class="card">
                    <div class="card-body">
                                <div style="display:flex;justify-content:flex-end;">
                                    <form class="form-inline" action="{{ route('salesRegister.search') }}"
                                        method="POST">
                                        @csrf
                                ...
                                <table class="table table-bordered data-table text-center global-table" id="myTable">
                                    <thead class="thead-light">
                                        <tr>
                                            ...
                                            <th class="text-nowrap">Customer Adress</th>
                                    ...
                                    {{-- <tbody>
                                        ...
                                        @empty
                                            <tr><td colspan="10">No any sales register.</td></tr>
                                        @endforelse
                                    </tbody> --}}
                                </table>
                                {{-- <div class="mt-3">
