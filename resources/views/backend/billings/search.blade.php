    ...
    <div class="sec-header">
      <div class="container-fluid">
        <div class="sec-header-wrap">
                ...
                @else
                    <h1 class="m-0">Search {{$billingtype->billing_types}} Bills </h1>
                @endif
          <div class="btn-bulk">
            @if ($billingtype->slug == "debit-note" || $billingtype->slug == "credit-note")
                <a href="{{route('billings.unapproved', $billingtype->id)}}" class="global-btn">Unapproved {{$billingtype->billing_types}} Bills</a> <a href="{{route('billings.cancelled', $billingtype->id)}}" class="global-btn">Cancelled {{$billingtype->billing_types}} Bills</a> @if ($billingtype->slug != "quotation") <a href="{{route('billings.materialized', $billingtype->id)}}" class="global-btn">Materialized {{$billingtype->billing_types}} Bills</a>  <a href="{{route('billings.cbms', $billingtype->id)}}" class="global-btn">CBMS Materialized {{$billingtype->billing_types}} Bills </a>@endif
            @else
                @php
                ...
                @endphp
                <a href="{{route($url)}}" class="global-btn">Create {{$billingtype->billing_types}}</a> <a href="{{route('billings.unapproved', $billingtype->id)}}" class="global-btn">Unapproved {{$billingtype->billing_types}} Bills</a> <a href="{{route('billings.cancelled', $billingtype->id)}}" class="global-btn">Cancelled {{$billingtype->billing_types}} Bills</a> @if ($billingtype->slug != "quotation") <a href="{{route('billings.materialized', $billingtype->id)}}" class="global-btn">Materialized {{$billingtype->billing_types}} Bills</a>  <a href="{{route('billings.cbms', $billingtype->id)}}" class="global-btn">CBMS Materialized {{$billingtype->billing_types}} Bills </a>@endif
            @endif
          </div>
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-body mid-body">
                ...
                <div class="btn-bulk">
                    <button type="submit" name="submit" class="global-btn clicked">Unapprove Selected</button>
                </div>
                </form>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="m-0 float-right">
                            <form class="form-inline" action="{{route('billings.search', $billingtype->id)}}" method="POST">
                                @csrf
                    ...
                    <div class="col-md-12 table-responsive mt">
                        <table class="table table-bordered data-table text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><input name='select[]' type='checkbox' class='select' value='{{$billing->id}}'></td>
                                        ...
                                        <div class="btn-bulk justify-content-center">
                                            ...
                                            @php
                                                ...
                                                if($billingtype == 2){
                                                    ...
                                                    <a href='$debitnoteurl' class='edit btn btn-primary icon-btn btn-sm' data-toggle='tooltip' data-placement='top' title='Create Debit Note'><i class='fas fa-credit-card'></i></a>
                                                ...
                                                elseif($billingtype == 1)
                                                {
                                                    ...
                                                    $btn = "<a href='$showurl' class='edit btn btn-primary icon-btn btn-sm'  data-toggle='tooltip' data-placement='top' title='View'><i class='fa fa-eye'></i></a>
                                                    <a href='$editurl' class='edit btn btn-secondary icon-btn btn-sm' data-toggle='tooltip' data-placement='top' title='Edit'><i class='fa fa-edit'></i></a>
                                                    <a href='$creditnoteurl' class='edit btn btn-primary icon-btn btn-sm' data-toggle='tooltip' data-placement='top' title='Create Credit Note'><i class='fas far fa-credit-card'></i></a>
                                                    <button type='button' class='btn btn-secondary icon-btn btn-sm' data-toggle='modal' data-target='#cancellation' data-toggle='tooltip' data-placement='top' title='Cancel'><i class='fa fa-ban'></i></button>
                                                    <form action='$statusurl' method='POST' style='display:inline-block;padding:0;' class='btn'>
                                                    <input type='hidden' name='_token' value='$csrf_token'>
                                                        <button type='submit' name = '$title' class='btn $btnclass btn-sm' data-toggle='tooltip' data-placement='top' title='$title'><i class='$btnname'></i></button>
