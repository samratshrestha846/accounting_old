                            ...
                            <div class="col-md-12">
                                <div class="m-0 float-right">
                                    <form class="form-inline"
                                        action="{{ route('billings.cbmssearch', $billingtype->id) }}" method="POST">
                                        @csrf
                                    ...
                                    <tbody>
                                        @forelse ($billings as $billing)
                                            <tr>
                                                ...
                                                <td class="text-nowrap">{{ $billing->grandtotal }}</td>
                                                <td class="text-nowrap">{{ $billing->sync_ird == 1 ? 'Yes' : 'No' }}</td>
                                                <td class="text-nowrap">{{ $billing->is_printed == 1 ? 'Yes' : 'No' }}</td>
                                                <td class="text-nowrap">{{ $billing->is_active == 1 ? 'Yes' : 'No' }}</td>
                                                <td class="text-nowrap">
                                                    @php
                                                ...
                                                <td class="text-nowrap">{{ $billing->is_realtime == 1 ? 'Yes' : 'No' }}</td>
                                                <td class="text-nowrap">{{ $billing->payment_modes->payment_mode ?? '' }}</td>
                                                <td class="text-nowrap">{{ $billing->vat_refundable }}</td>
                                                <td class="text-nowrap">{{ $billing->transaction_no }}</td>
                                            </tr>
                                        @empty
                                            <tr><td colspan="22">No data yet.</td></tr>
                                        @endforelse
                                    </tbody>
                                </table>
                                <div class="mt-3">
