                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="m-0 float-right">
                            <form class="form-inline" action="{{route('billings.vatrefundsearch')}}" method="POST">
                                @csrf
                    ...
                    <div class="col-md-12 table-responsive">
                        <table class="table table-bordered data-table text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$billing->client->pan_vat == null ? "Not Provided" : $billing->client->pan_vat}}</td>
                                    ...
                                    <td>{{$billing->client->client_code == null ? "Not Provided" : $billing->client->client_code}}</td>
