        ...
        <div class="sec-header">
            <div class="container-fluid">
                <div class="sec-header-wrap">
                    <h1 class="m-0">{{ $billingtype->billing_types }} Bills </h1>
                    <div class="btn-bulk">
                        ...
                        @if ($billingtype->slug == 'sales')
                            <a href="#" data-toggle='modal' data-target='#update_csv_non_importer' data-toggle='tooltip'
                            data-placement='top' class="global-btn" title="Update Sales from CSV">Import Sales</a>
                            <a href="#" data-toggle='modal' data-target='#update_csv_non_importer' data-toggle='tooltip'
                            data-placement='top' class="global-btn" title="Update Sales from CSV">Import Sales Item</a>
                        @elseif($billingtype->slug == 'purchase')
                            <a href="#" data-toggle='modal' data-target='#update_csv' data-toggle='tooltip'
                            data-placement='top' class="global-btn" title="Update Purchase from CSV">Import Purchase</a>
                            <a href="#" data-toggle='modal' data-target='#update_csv' data-toggle='tooltip'
                            data-placement='top' class="global-btn" title="Update Purchase from CSV">Import Purchase Item</a>
                        @endif
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="card-body mid-body">
                        <form action="" class="form-center">
                            ...
                            <div class="btn-bulk">
                                ...
                                <a href="javascript:void(0)" class="global-btn csvbilled" style="margin-left:5px;">Export (CSV)</a>
                                <form style="display: inline;" id="exportcsv"
                                    action="{{ route('exportSalesBills', ['id' => $current_fiscal_year->id, 'billingtype_id' => $billingtype->id]) }}"
                                    method="POST">
                                    @csrf
                                    <input type="hidden" name="selectedcsvid" class="selectedcsvid">
                                </form>
                                <button type="submit" name="submit" class="global-btn clicked" style="margin-left:5px;">
                                    Unapprove Selected</button>
                                    <a href="#" class="btn btn-primary" style="float:right;margin-left:5px;" disable>Total:Rs. {{number_format($total_sum,2)}}</a>
                            </div>
                        </form>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered data-table text-center " id="myTable">
                                ...
                                {{-- <tbody>
                                                        ...
                                                        if ($billingtype == 2) {
                                                            ...
                                                            $btn = "<a href='$showurl' class='edit btn btn-primary icon-btn btn-sm'  data-toggle='tooltip' data-placement='top' title='View'><i class='fa fa-eye'></i></a>
                                                                        ...
                                                                        <input type='hidden' name='_token' value='$csrf_token'>
                                                                            <button type='submit' name = '$title' class='btn $btnclass btn-secondary btn-sm' data-toggle='tooltip' data-placement='top' title='$title'><i class='$btnname'></i></button>
                                                                        </form>
                                                                        <!-- Modal -->
                                                            ...
                                                            $btn = "<a href='$showurl' class='edit btn btn-primary icon-btn btn-sm'  data-toggle='tooltip' data-placement='top' title='View'><i class='fa fa-eye'></i></a>
                                                                        ...
                                                                        <form action='$statusurl' method='POST' style='display:inline-block;padding:0;' class='btn'>
                                                                        <input type='hidden' name='_token' value='$csrf_token'>
                                                                            <button type='submit' name = '$title' class='btn $btnclass btn-primary btn-sm' data-toggle='tooltip' data-placement='top' title='$title'><i class='$btnname'></i></button>
                                                                        </form>
                                                                        <!-- Modal -->
                                                                            <div class='modal fade text-left' id='cancellation' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel' aria-hidden='true'>
                                                                                <div class='modal-dialog' role='document'>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="9">No any bills yet.</td>
                                        </tr>
                                    @endforelse
                                </tbody> --}}
                            </table>
        ...
        <div class='modal fade text-left' id='update_csv_non_importer' tabindex='-1' role='dialog'
                ...
                <div class='modal-dialog' role='document' style="max-width: 800px;">
                    <div class='modal-content'>
                        ...
                        <div class='modal-body'>
                            ...
                            <form action="{{ route('sales-import-demo') }}" method="post">
                                @csrf
                                <div class="btn-bulk">
            ...
            <div class='modal fade text-left' id='update_csv' tabindex='-1' role='dialog'
                ...
                <div class='modal-dialog' role='document' style="max-width: 800px;">
                    <div class='modal-content'>
                        <div class='modal-header text-center'>
                            <h2 class='modal-title' id='exampleModalLabel'>Update Purchase from CSV</h2>
                            <button type='button' class='close' data-dismiss='modal' aria-label='Close'>
                                <span aria-hidden='true'>&times;</span>
                            </button>
                        </div>
                        <div class='modal-body'>
                            ...
                            <form action="{{ route('purchase-import-demo') }}" method="post">
                                @csrf
                                <div class="btn-bulk">
                                    <button type="submit" class="btn btn-secondary btn-sm mt-2" name="modal_button"><i class="fas fa-download "> </i> Demo</button>
                                </div>
...
<script src="{{ asset('backend/dist/js/mousetrap/purchase.js') }}"></script>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            // console.log(billing_type_id);
            var url = "{{route('billings.report',':id')}}";
