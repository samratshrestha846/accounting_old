        ...
        <div class="sec-header">
            <div class="container-fluid">
                <div class="sec-header-wrap">
                    <h1>Search {{ $billingtype->billing_types }} Register Bills </h1>
                    <div class="btn-bulk"> <a
                        href="{{ route('billings.report', $billing_type_id) }}" class="global-btn">View
                        {{ $billingtype->billing_types }}</a></h1>
                    </div>
                    <!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="m-0 float-right">
                                    <form class="form-inline" action="{{ route('purchaseRegister.search') }}"
                                        method="POST">
                                        @csrf
                            ...
                            <div class="col-md-12 table-responsive">
                                <table class="table table-bordered data-table text-center">
                                    ...
                                    <tbody>
                                        ...
                                        @empty
                                            <tr><td colspan="10">No search results.</td></tr>
                                        @endforelse
                                    </tbody>
                                </table>
                                <div class="mt-3">
