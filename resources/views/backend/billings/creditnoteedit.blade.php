        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="card">
                    ...
                    <div class="card-body"><div class="ibox">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" name="client_id" class="form-control cli" readonly="readonly" value="">
                                                <p class="text-danger">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="ledger_no" value="{{$billing->ledger_no}}" required>
                                                <p class="text-danger">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-gorup">
                                                ...
                                                <select name="godown" id="godown" class="form-control" readonly="readonly">
                                                    <option value="{{$selgodown->id}}" selected>{{$selgodown->godown_name}}</option>
                                                </select>
                                            </div>
                                        </div>
                                                ...
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="item-row">
                                                            <td>
                                                                <input type="hidden" class="form-control itemid"
                                                                    placeholder="Particulars" type="text" name="particulars[]" value="{{$billingextra->particulars}}">
                                                                    <div class="delete-btn">
                                                                        ...
                                                                        @foreach ($categories as $category)
                                                                            ...
                                                                            @foreach ($category->products as $product)
                                                                                ...
                                                                                {{$product->product_name}}({{$product->product_code}}){{(!empty($product->brand->brand_name)) ? '-'.$product->brand->brand_name: ""}}</option>
                                                                            @endforeach
                                                                        @endforeach
                                                            ...
                                                            <td>
                                                                <input class="form-control unit" placeholder="Unit" type="text"
                                                                    name="unit[]" value="{{$billingextra->unit}}">
                                                                <p class="text-danger">
                                                                    {{ $errors->first('unit') }}
                                                                </p>
                                                            </td>
                                                                                    ...
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-9">
                                                                                            <select name="discounttype[]"
                                                                                                ...
                                                                                                <option value="percent" {{$billingextra->discounttype == "percent" ? 'selected' : ''}}>Percent
                                                                                                    %</option>
                                                                                                <option value="fixed" {{$billingextra->discounttype == "fixed" ? 'selected' : ''}}>Fixed
                                                                                                </option>
                                                                                            </select>
                                                                                        </div>
                                                                                    </div>
                                                            ...
                                                            <td>
                                                                <input type="text" name="taxamt[]" class="form-control taxamt"
                                                                    value="0"> <input type="text" name="itemtax[]" class="form-control itemtax" value="0" style="display: none;">
                                                                                    ...
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-9">
                                                                                            <select name="taxtype[]"
                                                                                                ...
                                                                                                <option value="exclusive" {{$billingextra->taxtype == "exclusive" ? "selected" : ""}}>
                                                                                                    Exclusive</option>
                                                                                                <option value="inclusive" {{$billingextra->taxtype == "inclusive" ? "selected" : ""}}>
                                                                                                    Inclusive</option>
                                                                                            </select>
                                                                                        </div>
                                                                                    </div>
                                                                                        ...
                                                                                        <div class="col-9">
                                                                                            <select name="tax[]"
                                                                                                ...
                                                                                                @foreach ($taxes as $tax)
                                                                                                    <option
                                                                                                        value="{{ $tax->percent }}" {{$billingextra->tax == $tax->percent ? "selected" : ""}}>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><span id="totalQty" style="color: red; font-weight: bold">0</span> Units</td>
                                                            <td></td>
                                                            <td></td>
                                                            <td></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" name="taxamount"
                                                                    id="taxamount" class="form-control off" value="0">
                                                                <input type="text" name="taxamount" class="gtaxamount form-control on" value="0">
                                                                <p class="text-danger">
