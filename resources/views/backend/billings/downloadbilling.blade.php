...
<body>
	...
	<table style="text-align:left;margin-top:20px;">
		<thead>
			<tr>
				<th width="33.3333%" style="font-size:15px;text-transform: uppercase;text-align:left;">Bill To:</th>
	...
	<table style="text-align: left;margin-top:10px;" class="items-table">
        ...
        <tbody>
           ...
           <tr>
                   ...
                   <td>Total</td>
                   <td style="{{$quotationsetting->show_picture == 0 ? "display:none" : ""}};border-top:1px solid #000;border-bottom:1px solid #000;"></td>
                   <td style="{{$quotationsetting->show_brand == 0 ? "display:none" : ""}};border-top:1px solid #000;border-bottom:1px solid #000;"></td>
                   <td style="{{$quotationsetting->show_model == 0 ? "display:none" : ""}};border-top:1px solid #000;border-bottom:1px solid #000;"></td>
                   <td style="border-top:1px solid #000;border-bottom:1px solid #000;"></td>
                   <td style="border-top:1px solid #000;border-bottom:1px solid #000;"></td>
                   <td style="border-top:1px solid #000;border-bottom:1px solid #000;"></td>
                   <td style="border-top:1px solid #000;border-bottom:1px solid #000;"></td>
                   <td style="text-align: right;border-top:1px solid #000;border-bottom:1px solid #000;">Rs. {{$billing->subtotal}}</td>
           </tr>
           <tr>
                ...
                <td style="padding-left:0;padding-top:20px;"><b style="display: block;line-height:10px;">Sub Total</b></td>
                <td style="text-align: right;padding-top:20px;">Rs.  {{$billing->subtotal}}</td>
            </tr>
            <tr>
                <td style="padding-left:0;padding:0;"><b style="display: block;line-height:10px;">Discount</b></td>
                <td style="text-align: right;padding:0;">Rs. {{$billing->discountamount}}</td>
            </tr>
            <tr>
                <td style="padding-left:0;padding:0;"><b style="display: block;line-height:10px;">Tax amount</b></td>
                <td style="text-align: right;padding:0;">Rs. {{$billing->taxamount}}</td>
            </tr>
            <tr>
                <td style="padding-left:0;padding:0;"><b style="display: block;line-height:10px;">Shipping</b></td>
                <td style="text-align: right;padding:0;">Rs. {{$billing->shipping}}</td>
            </tr>
            {{-- <tr>
                <td style="padding-left:0;"><b>VAT 13%@13.0%</b></td>
                <td style="text-align: right;">Rs. 1450.00</td>
            </tr> --}}
            <tr style="background:#df4c1b;color:#fff;">
       ...
       <thead>
        ...
        <tbody>
           ...
           <tr>
                ...
                <td style="border-top:1px solid {{$invoice_color}};border-bottom:1px solid {{$invoice_color}};">Total</td>
                <td style="border-top:1px solid {{$invoice_color}};border-bottom:1px solid {{$invoice_color}};"></td>
                <td style="border-top:1px solid {{$invoice_color}};border-bottom:1px solid {{$invoice_color}};"></td>
                <td style="border-top:1px solid {{$invoice_color}};border-bottom:1px solid {{$invoice_color}};"></td>
                <td style="border-top:1px solid {{$invoice_color}};border-bottom:1px solid {{$invoice_color}};"></td>
                <td style="text-align: right;border-top:1px solid {{$invoice_color}};border-bottom:1px solid {{$invoice_color}};">Rs. {{$billing->subtotal}}</td>
           </tr>
       </tbody>
        ...
        <tbody>
            <tr>
                        ...
                        <tr>
                            <td colspan="5" rowspan="5" style="vertical-align: top;">
                                ...
                                @php
                                        ...
                                        echo ucwords(convertNumberToWord($billing->subtotal).' only');
                                @endphp <br>
                                <b style="display: block;font-size:14px;vertical-align:middle;margin-top:10px;">Remarks:</b>
                                {{$billing->remarks}}<br>
                                <b style="display: block;font-size:14px;margin-top:10px;">Terms and Conditions:</b>
                                Thank you for doing business with us
                            </td>
                ...
                <td style="vertical-align:top;">
                    <table>
                        <tr>
                            <td style="padding-left:0;"><b style="display:block;">Sub Total</b></td>
                            <td style="text-align: right;">Rs.  {{$billing->subtotal}}</td>
                        </tr>
                        <tr>
                            <td style="padding-left:0;"><b style="display:block;">Discount</b></td>
                            <td style="text-align: right;">Rs. {{$billing->discountamount}}</td>
                        </tr>
                        <tr>
                            <td style="padding-left:0;"><b style="display:block;">Tax amount</b></td>
                            <td style="text-align: right;">Rs. {{$billing->taxamount}}</td>
                        </tr>
                        <tr>
                            <td style="padding-left:0;"><b style="display:block;">Shipping</b></td>
                            <td style="text-align: right;">Rs. {{$billing->shipping}}</td>
                        </tr>
