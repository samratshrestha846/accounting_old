    ...
    <section class="content mt-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <button type="submit" class="btn btn-primary" name="POS_generate">Generate Report</button>
                                </div>
                            </div>
                        </div>
                    </form>
            ...
            <div class="row mb-3">
                <div class="col-md-12 text-right">
                    <div class="btn-bulk">
                        ...
                        <form style="display: inline;" id="exportcsv" action="{{ route('exportfiltersalesBills', ['id' => $id, 'start_date' => $start_date, 'end_date' => $end_date, 'billingtype_id' => $billingtype->id]) }}" method="POST">
                            @csrf
                        ...
                        <form style="display: inline;" id="exportpdf" action="{{ route('pdf.generateSalesBillingReport', ['id' => $id, 'starting_date' => $starting_date, 'ending_date' => $ending_date, 'billingtype_id' => $billingtype->id]) }}" method="POST">
                            @csrf
                            <input type="hidden" name="export_POS" class="form-control" value="1">
                        </form>
                    </div>
        ...
        <div class="card">
            <div class="card-header text-center">
                ...
                <h5>From {{ $starting_date }} to {{ $ending_date }}</h5>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <form action="">
                            ...
                            <button type="submit" name="submit" class="btn btn-success btn-sm clicked"> &nbsp; Unapprove Selected</button>
                        </form>
                    </div>
                    <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2 pr-0">
                                    <select name="number_to_filter" class="form-control">
                                        ...
                                        <option value="250" {{ $number == 250 ? 'selected' : '' }}>250</option>
                                    </select>
                                </div>
                                <div class="col-md-2">
                                    <button type="submit" class="btn btn-success btn-sm" name="approved">Filter</button>
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="m-0 float-right">
                            <form class="form-inline" action="{{route('billings.search', $billingtype->id)}}" method="POST">
                                ...
                                <button type="submit" class="btn btn-primary mb-2" name="POS_generate"><i class="fa fa-search"></i></button>
                            </form>
                        </div>
                    </div>
                    <div class="col-md-12 table-responsive">
                        <table class="table table-bordered data-table text-center">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr><td colspan="10">No bills yet.</td></tr>
                                @endforelse
                            </tbody>
                        </table>
                        <div class="mt-3">
