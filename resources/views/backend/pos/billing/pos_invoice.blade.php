                ...
                <table class="table" cellspacing="0" border="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align:left; width:180px;">{{$billingExtra->product ? $billingExtra->product->product_name : 'Undefined'}}</td>
                            <td style="text-align:center; width:50px;">{{$billingExtra->quantity}}</td>
                            <td style="text-align: center: width:50px">{{$billingExtra->purchase_unit}}</td>
