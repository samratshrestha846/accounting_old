    ...
    <div class="sec-header">
        <div class="container-fluid">
            <div class="sec-header-wrap">
                <h1 class="m-0">Search Child-Account Types </h1>
                <div class="btn-bulk">
                ...
                <div class="row">
                    <div class="col-md-12 ">
                        <div class="m-0 float-right">
                            <form class="form-inline" action="{{route('childaccounts.search')}}" method="POST">
                                @csrf
                    ...
                    <div class="col-md-12 table-responsive">
                        <table class="table table-bordered data-table text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$childaccount->opening_balance == null?"-": $childaccount->opening_balance}}</td>
                                    <td>
                                        ...
                                        @php
                                            ...
                                            $csrf_token = csrf_token();
                                                $btn = "<a href='$editurl' class='edit btn btn-primary btn-sm' title='Edit'><i class='fa fa-edit'></i></a>
                                                        <button type='button' class='btn btn-secondary btn-sm' data-toggle='modal' data-target='#deletechild$childaccount->id' data-toggle='tooltip' data-placement='top' title='Delete'><i class='fa fa-trash'></i></button>
                                                        <!-- Modal -->
                        ...
                        <div class="mt-3">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <span class="pagination-sm m-0 float-right">{{ $childaccounts->links() }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
