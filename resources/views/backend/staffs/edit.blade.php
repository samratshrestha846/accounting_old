                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="employee_id" class="form-control"
                                                    value="{{ @old('employee_id', $staff->employee_id) }}" placeholder="Eg. - 001">
                                                @error('employee_id')
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="first_name" class="form-control"
                                                    value="{{ @old('first_name', $staff->first_name) }}" placeholder="Full Name">
                                                @error('first_name')
                                                    <p class="text-danger">{{ $message }}</p>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="gender" id="" class="form-control">
                                                    ...
                                                    @foreach ($genders as $gender)
                                                        <option value="{{ $gender }}" {{old('gender', $staff->gender) == $gender ? 'selected': ''}}>{{ $gender }}</option>
                                                    @endforeach
                                                </select>
                                                @error('gender')
                                                    <p class="text-danger">{{ $message }}</p>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="date_of_birth" class="form-control"
                                                    value="{{ @old('date_of_birth', $staff->date_of_birth) }}" placeholder="Y/m/d">
                                                @error('date_of_birth')
                                                    <p class="text-danger">{{ $message }}</p>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="department" id="" class="form-control">
                                                    ...
                                                    @foreach ($departments as $department)
                                                        <option value="{{ $department->id }}" {{old('department', $staff->department_id) == $department->id ? 'selected': ''}}>{{ $department->name }}</option>
                                                    @endforeach
                                                </select>
                                                @error('department')
                                                    <p class="text-danger">{{ $message }}</p>
                                                ...
                                                <select name="position" id="" class="form-control">
                                                    ...
                                                    @foreach ($position as $item)
                                                        <option value="{{ $item->id }}"
                                                            {{ $item->id == old('position',$staff->position_id) ? 'selected' : '' }}>
                                                            {{ $item->name }}</option>
                                                    @endforeach
                                                </select>
                                                @error('name')
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="join_date" class="form-control"
                                                    value="{{ @old('join_date', $staff->join_date) }}" placeholder="Y/m/d">
                                                @error('join_date')
                                                    <p class="text-danger">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="file" name="image" class="form-control"
                                                    value="{{ @old('image') }}">
                                                <p style="color: green">Donot select any image if you want previous image.
                                                </p>
                                                @error('image')
                                                    <p class="text-danger">{{ $message }}</p>
                                                @enderror
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <p style="color: green">Donot select any document if you want previous
                                                    document.</p>
                                                @error('national_id')
                                                    <p class="text-danger">{{ $message }}</p>
                                                @enderror
