        ...
        <div class="sec-header">
            <div class="container-fluid">
                <div class="sec-header-wrap">
                    <h1>Staffs </h1>
                    <div class="btn-bulk">
                        <a href="{{ route('staff.create') }}" class="global-btn">Add New Staff</a>
                    </div>
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
                                    ...
                                    <table class="table table-bordered yajra-datatable text-center">
                                        ...
                                        <tbody>
                                            @forelse ($staffs as $staff)
                                                <tr>
                                                    <td class="text-nowrap" style="width: 100px;"><img
                                                            src="{{ Storage::disk('uploads')->url($staff->image) }}"
                                                            style="max-height: 50px;"></td>
                                                    <td class="text-nowrap">{{ $staff->employee_id }}</td>
                                                    <td class="text-nowrap">{{ $staff->fullName }}</td>
                                                    <td class="text-nowrap">{{ $staff->position  ? ($staff->position['name'] ?? null) : '—' }}</td>
                                                    <td class="text-nowrap">{{ $staff->department ? $staff->department->name : '—' }}</td>
                                                        ...
                                                        <div class="btn-bulk justify-content-center">
                                                            ...
                                                            if ($staff->status == 0) {
                                                                $btn = "<a href='$editurl' class='edit btn btn-primary icon-btn btn-sm' title='Edit'><i class='fa fa-edit'></i></a>
                                                                                                                                                                                                                                                                                                                <a href='$showurl' class='edit btn btn-secondary icon-btn btn-sm' title='Edit'><i class='fa fa-eye'></i></a>
                                                                ...
                                                                $btn = "<a href='$editurl' class='edit btn btn-secondary icon-btn btn-sm' title='Edit'><i class='fa fa-edit'></i></a>
                                                                                                                                                                                                                                                                                                                <a href='$showurl' class='edit btn btn-primary icon-btn btn-sm' title='Edit'><i class='fa fa-eye'></i></a>
                                            ...
                                            @empty
                                                <tr><td colspan="7">No staffs yet.</td></tr>
                                            @endforelse
                                        </tbody>
                                    </table>
                                    <div class="mt-3">
