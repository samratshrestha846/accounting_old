                                                ...
                                                <table class="table table-bordered data-table text-center">
                                                    ...
                                                    <tbody>
                                                        @foreach ($services as $service)
                                                            <tr>
                                                                <td class="text-nowrap">{{ $service->service_code }}
                                                                </td>
                                                                <td class="text-nowrap">{{ $service->service_name }}
                                                                </td>
                                                                <td class="text-nowrap">
                                                                    {{ $service->category->category_name }}
                                                                </td>
                                                                <td class="text-nowrap">Rs. {{ $service->cost_price }}
                                                                    <td class="text-nowrap">Rs. {{ $service->sale_price }}
                                                                </td>
                                                                <td class="text-nowrap">
                                                                    {{ $service->status == 1 ? 'Approved' : 'Unapproved' }}
                                                                </td>
