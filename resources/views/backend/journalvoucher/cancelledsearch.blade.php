            ...
            <div class="container-fluid">
                <div class="sec-header">
                    <div class="sec-header-wrap">
                        <h1>Search Cancelled Journal Vouchers</h1>
                        <div class="btn-bulk"><a
                            href="{{ route('journals.create') }}" class="global-btn">Entry New Journal</a> <a
                            href="{{ route('journals.index') }}" class="global-btn">View Journals</a></h1>
                        </div>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
