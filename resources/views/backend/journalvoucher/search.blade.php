        ...
        <div class="sec-header">
            <div class="container-fluid">
                <div class="sec-header-wrap">
                    <h1>Search Journal Vouchers</h1>
                    <div clas="bulk-btn">
                        <a href="{{ route('journals.create') }}" class="global-btn">Entry New Journal</a> <a
                            href="{{ route('journals.cancelled') }}" class="global-btn">Cancelled Journals</a> <a
                            href="{{ route('journals.unapproved') }}" class="global-btn">Unapproved Journals</a>
                    </div>
                </div>
                <div class="card">
                ...
                <section class="content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <a href="{{ route('exportjournal', $current_fiscal_year->id) }}"
                                class="global-btn">Export
                                (CSV)</a>
                        </div>
                        <div class="col-md-12 mt">
                            <div class="card">
                                ...
                                <div class="card-body mid-body">
                                    <h4 class="text-center">For the fiscal year
                                    ...
                                    <form action="" class="form-center">
                                        ...
                                        <div class="bulk-btn">
                                            <button type="submit" name="submit"
                                                class="global-btn clicked">Unapprove
                                                Selected</button>
                                        </div>
                                    </form>
                                </div>
                                        ...
                                        <div class="mt-3">
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <p class="text-sm">
                                                        Showing
                                                        <strong>{{ $journalvouchers->firstItem() }}</strong> to
