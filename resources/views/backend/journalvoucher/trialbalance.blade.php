    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="btn-bulk">
                    <a href="{{ route('pdf.generateTrialBalance') }}" class="global-btn">Export (PDF)</a>
                    <a href="{{ route('exporttrialbalance', $current_fiscal_year->id) }}"
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body mid-body text-center">
                                <h4 style="margin-bottom:0;">For the fiscal year {{ $current_fiscal_year->fiscal_year }}
                                </h4>
                            </div>
