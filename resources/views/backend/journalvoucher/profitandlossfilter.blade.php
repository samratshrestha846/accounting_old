    ...
    <div class="content-wrapper">
                                        ...
                                        <select name="fiscal_year" class="form-control fiscal">
                                            @foreach ($fiscal_years as $fiscal_year)
                                                <option value="{{ $fiscal_year->fiscal_year }}"
                                                    {{ $fiscal_year->id == $selected_fiscal_year->id ? 'selected' : '' }}>
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="btn-bulk">
                    <a href="{{ route('pdf.generateProfitandLossReport', ['id' => $selected_fiscal_year->id, 'starting_date' => $starting_date, 'ending_date' => $ending_date]) }}"
                        class="global-btn">Export (PDF)</a> <a
                        href="{{ route('exportfilterprofitandloss', ['id' => $selected_fiscal_year->id, 'starting_date' => $starting_date, 'ending_date' => $ending_date]) }}"
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body mid-body">
                                <h4>For the fiscal year of {{ $selected_fiscal_year->fiscal_year }}
                                    ({{ $starting_date }} to {{ $ending_date }})</h4>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="tr-light">
                                                    <td class="text-center">
                                                        <b style="font-size: 14px;">Total Income</b>
                                                    </td>
                                                    <td>
                                                        <b>
                                                            @if ($income_sum < 0)
                                                ...
                                                <tr>
                                                    <td>
                                                        <h4><span style="font-size: 14px;">Less:</span> Cost Of Goods Sold
                                                        </h4>
                                                    </td>
                                                    <td></td>
                                                </tr>
                                                ...
                                                <tr class="tr-light">
                                                    <td class="text-center">
                                                        <b style="font-size: 14px;">Total Cost of Sales</b>
                                                    </td>
                                                    <td>
                                                        <b>
                                                            @if ($diff < 0)
                                                ...
                                                <tr class="tr-light">
                                                    <td class="text-center">
                                                        <b style="font-size: 14px;">Gross Profit / Loss</b>
                                                    </td>
                                                    <td>
                                                        <b>
                                                            @php
