    ...
    <section class="content">
        <div class="container-fluid">
                ...
                <div style="text-align: center">
                    <span style="display: block;font-size:17px;margin-top:10px;margin-bottom:15px;">Trial Balance for the fiscal year {{ $current_fiscal_year->fiscal_year }}</span>
                </div>
                    ...
                    <div class="col-md-12">
                        <table style="width: 100%">
                            ...
                            @foreach ($mainaccounts as $account)
                                ...
                                @endphp
                                <tbody>
                                    <tr style="background-color: #ebf3fb; color: black;">
