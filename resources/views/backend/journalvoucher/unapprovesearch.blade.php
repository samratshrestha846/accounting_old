        ...
        <div class="container-fluid">
            <div class="sec-header">
                <div class="sec-header-wrap">
                    <h1>Search Unapproved Journal Vouchers </h1>
                    <div class="btn-bulk">
            ...
            <section class="content">
                ...
                <div class="card">
                    <div class="card-header">
                        <h2>Unapproved Journal Voucher</h2>
                    </div>
                    <div class="card-body mid-body">
                        <form action="" class="form-center">
                            ...
                            <div class="bulk-btn">
                                <button type="submit" name="submit" class="global-btn btn-sm clicked">Approve
                                    Selected</button>
                            </div>
                        </form>
                    </div>
                                                    ...
                                                    @php
                                                        ...
                                                        $btn = "<a href='$showurl' class='edit btn btn-primary btn-sm'  data-toggle='tooltip' data-placement='top' title='View'><i class='fa fa-eye'></i></a>
                                                                                                            ...
                                                                                                            <input type='hidden' name='_token' value='$csrf_token'>
                                                                                                                <button type='submit' name = '$title' class='btn $btnclass btn-secondary text-light btn-sm ml-1' data-toggle='tooltip' data-placement='top' title='$title'><i class='$btnname'></i></button>
                                                                                                            </form>
                                                                                                            <!-- Modal -->
