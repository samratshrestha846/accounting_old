    ...
    <section class="content">
        <div class="container-fluid">
                ...
                <div style="text-align: center">
                    ...
                    <span  style="display: block;">For the fiscal year {{ $current_fiscal_year->fiscal_year }}</span>
                    <span style="display: block;margin-bottom:15px;">As on {{ $date_in_nep }}</span>
                </div>
                                ...
                                <tr style="background-color: #ebf3fb;">
                                    ...
                                    <td>
                                        @php
                                            ...
                                            // dd($creditadd);
                                            $subdebitsum = array_sum($debitadd);
                                            $subcreditsum = array_sum($creditadd);
                                            $child_opening_balance_sum = array_sum($child_opening_balances);
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @php
                                                ...
                                                if($amount >= 0){
                                                    echo number_format($amount, 2) . ' Dr';
                                                }else{
                                                    echo number_format($amount * -1, 2) . ' Cr';
                                                }
                                            @endphp
                                        </td>
                                    </tr>
