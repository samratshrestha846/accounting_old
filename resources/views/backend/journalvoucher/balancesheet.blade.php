    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="btn-bulk">
                    <a href="{{ route('pdf.generateBalanceSheet') }}" class="global-btn">Export (PDF)</a>
                    <a href="{{ route('exportbalancesheet', $current_fiscal_year->id) }}"
