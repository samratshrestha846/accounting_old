            ...
            <div class="container-fluid">
                <div class="sec-header-wrap">
                    ...
                    <div class="btn-bulk">
                        ...
                        <a href="{{ route('bankLedgers') }}" class="global-btn">View Bank Ledgers</a>
                    </div>
                    <!-- /.col -->
                </div><!-- /.row -->
                            ...
                            <div class="table-responsive mt noscroll">
                                <table class="table table-bordered data-table text-center global-table">
                                    ...
                                    <tbody>
                                                ...
                                                <td>
                                                    <div class="btn-bulk">
                                                        <a href='{{ route('bank.show', $bank->id) }}'
                                                            class='edit btn btn-primary icon-btn btn-sm' title='Show'><i
                                                                class='fa fa-eye'></i></a>
                                        ...
                                        @empty
                                            <tr><td colspan="5">No bank information yet.</td></tr>
                                        @endforelse
                                    </tbody>
                                </table>
                                <div class="mt-3">
