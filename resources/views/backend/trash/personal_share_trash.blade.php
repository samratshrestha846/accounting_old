                                    ...
                                    <tbody>
                                        @forelse ($personalshares as $personalshare)
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $restoreurl = route('restorePersonalShare', $personalshare->id);
                                                        $btn = "<button type='button' class='btn btn-primary icon-btn btn-sm' data-toggle='modal' data-target='#restoreaccount$personalshare->id' data-toggle='tooltip' data-placement='top' title='Restore'><i class='fa fa-trash-restore'></i></button>
                                                                                                                                                                                                                                                                                                                                                <!-- Modal -->
                                                                                                                                                                                                                                                                                                                                                    <div class='modal fade text-left' id='restoreaccount$personalshare->id' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel' aria-hidden='true'>
                                        ...
                                        @empty
                                            <tr><td colspan="5">No personal shares trashed yet.</td></tr>
                                        @endforelse
                                    </tbody>
                                </table>
                                <div class="mt-3">
