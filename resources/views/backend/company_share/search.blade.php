        ...
        <div class="sec-header">
            <div class="container-fluid">
                <div class="sec-header-wrap">
                    <h1>Search Company Shares</h1>
                    <div class="btn-bulk">
                        <a href="{{ route('company_share.create') }}" class="global-btn">Create Company Share</a>
                    </div>
                </div><!-- /.row -->
                        ...
                        <div class="row">
                            <div class="col-md-12 ">
                                <div class="m-0 float-right">
                                    <form class="form-inline" action="{{ route('companyshare.search') }}"
                                        method="POST">
                                        @csrf
                            ...
                            <div class="col-md-12 table-responsive mt">
                                <table class="table table-bordered data-table text-center">
                                    ...
                                    <tbody>
                                        @foreach ($companyshares as $companyshare)
                                            <tr>
                                                ...
                                                <td style="width: 120px;">
                                                    <div class="btn-bulk justify-content-center">
                                                        @php
                                                        $editurl = route('company_share.edit', $companyshare->id);
                                                        $showurl = route('company_share.show', $companyshare->id);
                                                        $deleteurl = route('company_share.destroy', $companyshare->id);
                                                        ...
                                                        $btn = "<a href='$showurl' class='edit btn btn-primary icon-btn btn-sm' title='Show'><i class='fa fa-eye'></i></a>
                                                                                                                                                                        ...
                                                                                                                                                                        <button type='button' class='btn btn-primary icon-btn btn-sm' data-toggle='modal' data-target='#deletechild$companyshare->id' data-toggle='tooltip' data-placement='top' title='Delete'><i class='fa fa-trash'></i></button>
                                                                                                                                                                        <!-- Modal -->
                                                                                                                                                                            <div class='modal fade text-left' id='deletechild$companyshare->id' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel' aria-hidden='true'>
