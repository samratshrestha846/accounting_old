    ...
    <div class="content-wrapper">
        ...
        <div class="sec-header">
            <div class="container-fluid">
                <div class="sec-header-wrap">
                    <h1>Edit Company Share information </h1>
                    <div class="btn-bulk">
                        <a href="{{ route('company_share.index') }}" class="global-btn">View Company Shares</a>
                    </div>
                </div><!-- /.row -->
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <form action="{{ route('company_share.update', $companyShare->id) }}" method="POST"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="quantity_kitta" class="form-control"
                                                    ...
                                                    value="{{ $companyShare->quantity_kitta }}">
                                                <p class="text-danger">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="total_amount" class="form-control"
                                                    ...
                                                    value="{{ $companyShare->total_amount }}">
                                                <p class="text-danger">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="share_type" class="form-control">
                                                    ...
                                                    <option value="Promoter"
                                                        {{ $companyShare->share_type == 'Promoter' ? 'selected' : '' }}>
                                                        Promoter</option>
                                                    <option value="Ordinary"
                                                        {{ $companyShare->share_type == 'Ordinary' ? 'selected' : '' }}>
                                                        Ordinary</option>
                                                </select>
                                                <p class="text-danger">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    @if (count($company_shareholders) == 0)
                                        <div class="row">
                                            <div class="col-md-11" id="newshareholder_info">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="shareholder_name">Name: </label>
                                                            <input type="text" name="shareholder_name[]"
                                                                class="form-control" placeholder="Shareholder Name">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="shareholder_email[]"
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="shareholder_contact[]"
                                            ...
                                            <div class="col-md-1">
                                                <label>&nbsp;</label>
                                                <a href="" class="btn btn-primary icon-btn" title="Add new Shareholder"
                                                    onclick="addShareholderInfo()"><i class="fas fa-plus"></i></a>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="shareholder_email[]"
                                                                    ...
                                                                    value="{{ $shareholder->shareholder_email }}">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="shareholder_contact[]"
                                                                    class="form-control" placeholder="Contact no."
                                                                    value="{{ $shareholder->shareholder_contact }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                @endforeach
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="company_name" class="form-control"
                                                    value="{{ $companyShare->company_name }}" placeholder="Company Name">
                                                <p class="text-danger">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="pan_vat_no" class="form-control"
                                                    value="{{ $companyShare->pan_vat_no }}" placeholder="PAN / VAT no">
                                                <p class="text-danger">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="pan_vat_document">PAN / VAT document (Dont select new if you
                                                    want prevoius one):</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="company_contact_no" class="form-control"
                                                    value="{{ $companyShare->company_contact_no }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="company_email" class="form-control"
                                                    value="{{ $companyShare->company_email }}"
                                                    placeholder="eg:example@gmail.com  ">
                                                <p class="text-danger">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="company_paidup_capital" class="form-control"
                                                    value="{{ $companyShare->company_paidup_capital }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="company_capital" class="form-control"
                                                    value="{{ $companyShare->company_capital }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="last_year_audit_report">Last year Audit Report (Dont select new
                                                    if you want prevoius one):</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="project_field_report">Project Field (Jagga) Report (Dont select
                                                    new if you want prevoius one):</label>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="registration_date" class="form-control"
                                                    value="{{ $companyShare->registration_date }}"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="company_registration_no" class="form-control"
                                                    value="{{ $companyShare->company_registration_no }}"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="registration_documents">Registration Documents (Leave empty for
                                                    prevoius document):</label>
                                                ...
                                                <select name="registered_province_no" class="form-control province">
                                                    ...
                                                    @foreach ($provinces as $province)
                                                        <option value="{{ $province->id }}"
                                                            {{ $province->id == $companyShare->registered_province_no ? 'selected' : '' }}>
                                                ...
                                                <select name="registered_district_no" class="form-control" id="district">
                                                    @foreach ($districts as $district)
                                                        <option value="{{ $district->id }}"
                                                            {{ $district->id == $companyShare->registered_district_no ? 'selected' : '' }}>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="registered_local_address" class="form-control"
                                                    ...
                                                    value="{{ $companyShare->registered_local_address }}">
                                                <p class="text-danger">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="work_details" id="summernote" class="form-control"
                                                    cols="30" rows="10">{!! $companyShare->work_details !!}</textarea>
                                                <p class="text-danger">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="request_person_name" class="form-control"
                                                    value="{{ $companyShare->request_person_name }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="designation" class="form-control"
                                                    value="{{ $companyShare->designation }}"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="request_contact_no" class="form-control"
                                                    value="{{ $companyShare->request_contact_no }}"
                                                    placeholder="Phone no.">
                                                <p class="text-danger">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="request_email" class="form-control"
                                                    value="{{ $companyShare->request_email }}"
                                                    placeholder="Eg: example@gmail.com">
                                                <p class="text-danger">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="request_person_citizenship">Citizenship (Dont select new if you
                                                    want prevoius one):</label>
                                                <input type="file" name="request_person_citizenship"
                                                    class="form-control">
                                                <p class="text-danger">
    ...
    <script>
        function addShareholderInfo() {
            ...
            new_row.innerHTML = `
                                ...
                                `;
            var pos = x.childElementCount + x.childElementCount;
            console.log(pos);
