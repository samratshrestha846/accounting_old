        ...
        <div class="sec-header">
            <div class="container-fluid">
                <div class="sec-header-wrap">
                    <h1 class="m-0">New Service Sales Bills </h1>
                    <div class="btn-bulk">
                                    ...
                                    <div class="row mt-2">
                                                ...
                                                <table class="table table-bordered text-center" id="myTable">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="border:none;"></td>
                                                            <td style="border:none;"></td>
                                                            <td><strong>Taxs Amount</strong></td>
                                                            <td>
                                        ...
                                        <div class="col-md-12">
                                            <div class="row">
                                                    ...
                                                    <div class="col-md-2 paymentMethod">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-2 creditDate" style="display: none;">
                                                        <div class="form-group">
