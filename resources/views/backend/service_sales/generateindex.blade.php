            ...
            <div class="container-fluid">
                <div class="sec-header-wrap">
                    ...
                    <div class="btn-bulk">
                        ...
                        <a href="{{ route('unapprovedServiceBills') }}" class="global-btn">Unapproved Sales Bills</a>

                        <a href="{{ route('cancelledServiceBills') }}" class="global-btn">Cancelled Sales Bills</a>
                    </div>
