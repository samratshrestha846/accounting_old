            ...
            <div class="sec-header">
                <div class="container-fluid">
                    <div class="sec-header-wrap">
                        ...
                        <div class="btn-bulk">
                            <a href="{{ route('service_sales.index',['billing_type_id'=>1]) }}" class="global-btn">View Sales Bills</a>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <form action="{{ route('service_sales.store') }}" method="POST">
                                        ...
                                        <div class="row">
                                            ...
                                            <input type="hidden" name="reference_invoice_no" value="{{$serviceSale->reference_no}}">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="fiscal-year">Fiscal Year<i class="text-danger">*</i>:
                                                    </label>
                                                    <select name="fiscal_year_id" id="fiscal-id" class="form-control" readonly>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="nep_date" id="entry_date_nepali"
                                                                class="form-control" value="{{ $serviceSale->nep_date }}" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="v-add">
                                                        ...
                                                        <input type="hidden" name="client_id" value="{{$serviceSale->client_id}}" />
                                                        <p class="text-danger">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="ledger_no" value="{{ $serviceSale->ledger_no }}"
                                                        placeholder="VAT Bill No." required readonly>
                                                    <p class="text-danger">
                                                        ...
                                                        @foreach ($serviceSale->serviceSalesExtra as $key => $item)
                                                            <tr class="item-row" id="tr_row_{{ $key+1 }}">
                                                                <td>
                                                                    ...
                                                                    <select name="particulars[]" class="form-control item" id="item_{{ $key+1 }}" disabled onchange="showrate({{ $key+1 }})" >
                                                                ...
                                                                <td>
                                                                    <input class="form-control unit" placeholder="Unit" type="text"
                                                                        name="unit[]" value="{{ $item->unit }}" readonly>
                                                                    <p class="text-danger">
                                                                        {{ $errors->first('unit') }}
                                                                    </p>
                                                                </td>
                                                                <td>
                                                                    <input class="form-control rate" placeholder="Rate" type="text" value="{{ $item->rate }}"
                                                                        name="rate[]" id="rate_{{ $key }}" readonly>
                                                                    <p class="text-danger">
                                                                        {{ $errors->first('rate') }}
                                                                    </p>
                                                                </td>
                                        ...
                                        <div class="col-md-12 mt-4">
                                            <div class="row">
                                                ...
                                                <div class="row col-md-6 paymentMethod">
                                                    ...
                                                    <div class="col-md-4" id="online_payment" @if ($serviceSale->online_portal_id == null) style="display: none;" @endif>
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-4" id="customer_portal_id" @if ($serviceSale->customer_portal_id == null) style="display: none;" @endif>
                                                        <div class="form-group">
