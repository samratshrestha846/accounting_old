            ...
            <div class="sec-header">
                <div class="container-fluid">
                    <div class="sec-header-wrap">
                        ...
                        <div class="btn-bulk">
                            <a href="{{ route('service_sales.index',['billing_type_id'=>2]) }}" class="global-btn">View Purchase Bills</a>
                                                        ...
                                                        <select name="vendor_id" class="form-control" disabled>
                                                            ...
                                                            @foreach ($suppliers as $supplier)
                                                                <option value="{{ $supplier->id }}"
                                                                    {{ $supplier->id == $serviceSale->vendor_id ? 'selected' : '' }}>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" name="grandtotal" class="form-control"
                                                                    id="grandTotal" value="{{$serviceSale->grandtotal}}" readonly="readonly">
                                                                <p class="text-danger">
