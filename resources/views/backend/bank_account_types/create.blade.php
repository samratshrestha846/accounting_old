                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <h2>New Bank Account Info</h2>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('bankAccountType.store') }}" method="POST">
                                    @csrf
                                    @method("POST")
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="account_type_name" class="form-control"
                                                    placeholder="Enter Bank Account Type Name" value="{{ old('account_type_name') }}">
                                                <p class="text-danger">
