...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        {{-- <div class="btn-bulk mb-2 ml-3">
            <a href="{{route('bankledgerexportexcel')}}" class="global-btn">Export (CSV)</a>

            <form style="display: inline;" id="exportpdf" action="{{route('bankLedgersPdf')}}" method="POST">
                @csrf
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            {{-- <div class="col-md-4">
                                <form action="{{ route('bankLedgers') }}" method="GET">
                                    @csrf
                                    <div class="row">
                            ...
                            {{-- <div class="col-md-4 text-right">
                                <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for Bank name.." title="Type in a name">
                            </div> --}}
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-bulk justify-content-center">
                                                        <a href="{{ route('bank.show', $bank->id) }}" class="btn btn-primary icon-btn" title="View bank"><i class="fas fa-eye"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                        @empty
