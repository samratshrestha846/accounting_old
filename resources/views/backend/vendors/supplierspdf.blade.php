                    ...
                    <div class="col-md-12">
                        <table class="table mt-5" style="width: 100%;">
                            <thead style="background-color: #343a40;">
                                <tr>
                                    <th style="width: 250px; color:aliceblue">Company Name</th>
                                    <th style="width: 20px; color:aliceblue">Company Code</th>
                                    <th style="color:aliceblue;">Contact Person</th>
                                    <th style="color:aliceblue;">Company Email</th>
                                    <th style="color:aliceblue;">Company Phone</th>
                                    <th style="color:aliceblue;">Pan No./Vat No.</th>
                                </tr>
                            </thead>
                            <tbody>
                                @forelse ($suppliers as $vendor)
                                    <tr>
