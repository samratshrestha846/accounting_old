...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="sec-header">
            <div class="container-fluid">
                <div class="sec-header-wrap">
                    <h1>Purchase from Supplier Report</h1>
                    <div class="btn-bulk">
                        <a href="{{ route('vendors.index') }}" class="global-btn">View
                            All Suppliers</a> <a href="{{ route('supplier.debitnote', $supplier->id) }}"
                            class="global-btn">Debit Note
                            from Suppliers</a>
        ...
        {{-- <div class="btn-bulk mb-2 ml-3">
            <a href="{{route('supplierpurchaseExport',$supplier->id)}}" class="global-btn">Export (CSV)</a>

            <form style="display: inline;" id="exportpdf" action="{{ route('pdf.supplierpurchase', $supplier->id) }}" method="POST">
                @csrf
                            ...
                            <div class="col-md-12">
                                    ...
                                    <div class="col-md-8">
                                        @php
                                            ...
                                            foreach ($billings as $billing) {
                                               $totalpaid += $billing->payment_amount;
                                               $allpurchase += $billing->grandtotal;
                                            }

                                        @endphp

                                        <h5 class="btn-bulk">
                                            <span class="btn btn-primary">Total Purchase: Rs.{{ $allpurchase }}</span>
                                            <span class="btn btn-secondary">Total Paid: Rs.{{ $totalpaid }}</span>
                                            <span class="btn btn-primary">Total Due: Rs.{{ $allpurchase - $totalpaid }}</span>
                                        </h5>
                                    </div>
                                ...
                                <table class="table table-bordered mt text-center" id="myTable">
                                    ...
                                    <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-bulk justify-content-center">
                                                        <a href="{{ route('service_sales.show', $billing->id) }}"
                                                            class="btn icon-btn btn-primary" target="_blank" data-toggle='tooltip'
                                                            data-placement='top' title='View Billing'><i
                                                                class="fas fa-file-invoice-dollar"
                                                                data-title="View Bill"></i></a>
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <p><span class="badge badge-primary mr-2 p-1"><b>Total
                                                                        ...
                                                                        <span class="badge badge-success mr-2 p-1"><b>Paid
                                                                                Amount:
                                                                            </b>Rs.{{ $billing->payment_amount }}</span><span
                                                                            class="badge badge-danger dueamount mr-2 p-1"
                                                                            data-dueamount="{{ $billing->grandtotal - $billing->payment_amount }}"><b>Due
                                                                                Amount: </b>Rs.{{ $billing->grandtotal - $billing->payment_amount }}</span>
                                                                    </p>
                                                                    ...
                                                                    <div class="tab-content" id="myTabContent">
                                                                                ...
                                                                                <table class="table table-bordered">
                                                                                    ...
                                                                                    <tbody>
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td>
                                                                                                    {{ucfirst($billing->payment_type)}}
                                                                                                </td>
                                                                                                <td>{{ $billing->payment_amount }}
                                                                                                </td>
                                                                                                {{-- <td>{{ Auth::user()->name }}
                                                                                                </td> --}}
                                                                                                <td><a href='{{ route('service_sales.edit', $billing->id) }}'
                                                                        ...
                                                                        <div class="tab-pane fade"
                                                                            ...
                                                                            <div class="container p-3">
                                                                                @if ($billing->grantotal - $billing->payment_amount  <= 0)
                                        ...
                                        @empty
                                            <tr><td colspan="5">No purchase bills.</td></tr>
                                        @endforelse
                                    </tbody>
                                </table>
