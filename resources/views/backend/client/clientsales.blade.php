...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="sec-header">
            <div class="container-fluid">
                <div class="sec-header-wrap">
                    ...
                    <div class="btn-bulk">
                        <a href="{{ route('client.index') }}" class="global-btn">View All Customers</a> <a
                            href="{{ route('client.creditnote', $client->id) }}" class="global-btn">Customer
                            Credit
                            Note</a>
        ...
        <div class="btn-bulk mb-2 ml-3">
            <a href="{{route('clientsalesExport',$client->id)}}" class="global-btn">Export (CSV)</a>

            <form style="display: inline;" id="exportpdf" action="{{ route('pdf.clientsales', $client->id) }}" method="POST">
                @csrf
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        @endphp
                                        <h5 class="btn-bulk">
                                            <span class="btn btn-primary">Total Sales: Rs.{{ $totalsales }}</span>
                            ...
                            <div class="col-md-12 table-responsive">
                                                ...
                                                <td>
                                                    <div class="btn-bulk justify-content-center">
                                                        <a href="{{ route('billings.show', $billing->id) }}"
                                                            class="btn btn-primary icon-btn btn-sm" target="_blank"><i
                                                                class="fas fa-file-invoice-dollar" data-toggle='tooltip'
                                                                data-placement='top' title='View Bill'></i></a>
                                                        <a href="javascript:void(0)" class="btn btn-secondary icon-btn btn-sm"
                                                            data-toggle="modal"
                                                            data-target="#payment_details{{ $billing->id }}"
                                                            data-toggle='tooltip' data-placement='top' title='View Payment'><i
                                ...
                                <div class="mt-3">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <p class="text-sm">
                                                Showing <strong>{{ $billings->firstItem() }}</strong>
                                                to
                                                <strong>{{ $billings->lastItem() }} </strong> of
                                                <strong>
