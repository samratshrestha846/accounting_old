        ...
        <div class="sec-header">
            <div class="container-fluid">
                <div class="sec-header-wrap">
                    <h1>Cusotmer Credit Note Report </h1>
                    <div class="btn-bulk">
                        <a href="{{ route('client.index') }}" class="global-btn">View All Customers</a> <a
                            href="{{ route('client.sales', $client->id) }}" class="global-btn">Cusotmer
                            Sales</a>
                    </div>
                    <!-- /.col -->
                </div><!-- /.row -->
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        @endphp
                                        <h5 class="btn-bulk"><span class="btn btn-primary">Total Credit Note:
                                            Rs.{{ $totalsalesreturn }}</span> <span class="btn btn-secondary">Total
                                            Paid:
                                            Rs.{{ $totalpayment }}</span> <span class="btn btn-primary">Total Due:
                                            Rs.{{ $totaldue }}</span>
                                        </h5>
                                    </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered mt text-center" id="myTable">
                                        ...
                                        <tbody>
                                            ...
                                            @empty
                                                <tr><td colspan="5">No credit notes yet.</td></tr>
                                            @endforelse
                                        </tbody>
                                    </table>
