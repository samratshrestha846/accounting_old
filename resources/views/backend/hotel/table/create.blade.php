            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('hotel-table.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method("POST")
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select name="room" class="form-control select2">
                                                    ...
                                                    <option value="{{$room->id}}" {{old('room') == $room->id ? 'selected' : ''}}>{{$room->name.'('.$room->floor->name.')'}}</option>
                                                    @endforeach
                                                </select>
                                                <p class="text-danger">
                                                    {{ $errors->first('room') }}
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="table_name" class="form-control"
                                                    placeholder="Enter Table Name" value="{{ old('table_name') }}">
                                                <p class="text-danger">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="table_code" class="form-control"
                                                    placeholder="Enter Table Code" value="{{ old('table_code') }}"
                                                    id="table_code">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="1" name="max_capacity" class="form-control"
                                                    placeholder="Enter Table Capacity" value="{{ old('max_capacity') }}">
                                                <p class="text-danger">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <label class="switch pt-0">
                                                    <input type="checkbox" name="is_cabin" id="is_cabin" value="1" {{ old('is_cabin') == 1 ? 'checked' : '' }}>
                                        ...
                                        <div class="cabin-data col-md-3">
                                            ...
                                            <div class="form-group col-md-10">
                                                <label for="room_name">Cabin Type<i
                                                        class="text-danger">*</i></label>
                                                <select type="text" name="cabin_type" class="form-control">
                                                    <option value="">Select Cabin Type</option>
                                                    @foreach($cabin_types as $cabinType)
                                                        <option value="{{$cabinType->id}}" {{$cabinType->id == old('cabin_type') ? 'selected' : ''}}>{{$cabinType->name}}</option>
                                                    @endforeach
                                                </select>
                                                <p class="text-danger">
                                            ...
                                            <div class="col-md-2 pl-0" style="padding-left:7px;">
                                                <div class="form-group">
                                                    ...
                                                    <button type="button" data-toggle='modal'
                                                        ...
                                                        data-placement='top' class="btn btn-primary btn-sm icon-btn ml-auto"
                                        ...
                                        <div class="cabin-data col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="cabin_charge" class="form-control"
                                                    placeholder="Enter Cabion Charge" value="{{ old('cabin_charge') }}">
                                                <p class="text-danger">
