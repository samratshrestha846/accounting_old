            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('hotel-food.update', $food->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method("PATCH")
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="room">Category <i
                                                        class="text-danger">*</i></label>
                                                <select name="category" class="form-control">
                                                    <option value="">Select Category</option>
                                                    @foreach ($categories as $category)
                                                    <option value="{{$category->id}}" {{old('category', $food->category_id) == $category->id ? 'selected' : ''}}>{{$category->category_name}}</option>
                                                    @endforeach
                                                </select>
                                                <p class="text-danger">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="room">Kitchen <i
                                                        class="text-danger">*</i></label>
                                                <select name="kitchen" class="form-control">
                                                    <option value="">Select Kitchen</option>
                                                    @foreach ($kitchens as $kitchen)
                                                    <option value="{{$kitchen->id}}" {{old('kitchen', $food->kitchen_id) == $kitchen->id ? 'selected' : ''}}>{{$kitchen->kitchen_name}}</option>
                                                    @endforeach
                                                </select>
                                                <p class="text-danger">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="food_name">Food Name<i
                                                        class="text-danger">*</i></label>
                                                <input type="text" name="food_name" class="form-control"
                                                    placeholder="Enter Food Name" value="{{ old('food_name', $food->food_name) }}">
                                                <p class="text-danger">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="component" class="form-control"
                                                    placeholder="Eg- Salt,peeper, chicken" value="{{ old('component', $food->component) }}">
                                                <p class="text-danger">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" name="description" class="form-control" id="description">{{ old('remarks', $food->description) }}</textarea>
                                                <p class="text-danger">
                                        ...
                                        <div class="col-md-3">
                                            <div class='form-group'>
                                                ...
                                                <img src="{{ Storage::disk('uploads')->url($food->food_image) }}"
                                                        id="output" alt="{{$food->food_image}}" style="height: 50px;">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-2">
                                                    ...
                                                    <input type="number" name="cooking_time_hour" min="0" max="12" class="form-control"
                                                        id="inlineFormInputGroup" value="{{ old('cooking_time_hour',date('H',strtotime($food->cooking_time))) }}">
                                                    <div class="input-group-prepend">
                                                    ...
                                                    <input type="number" class="form-control" name="cooking_time_min" id="inlineFormInputGroup"
                                                        min="0" max="60" value="{{ old('cooking_time_min',date('i',strtotime($food->cooking_time))) }}">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="food_price" class="form-control"
                                                    placeholder="" value="{{ old('food_price', $food->food_price) }}">
                                                <p class="text-danger">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <label class="switch pt-0">
                                                    <input type="checkbox" name="status" id="status" value="1" {{ old('status', $food->status) == 1 ? 'checked' : '' }}>
