@extends('backend.hotel.pos.billing.pos_invoice')
@push('styles')
@endpush
@section('content')
<div id="buttons" style="padding-top:10px; text-transform:uppercase;">
    <div class="col">
        ...
        <span class="right" style="width:40%;">
            <a href="{{route('hotel_order.pos.generateinvoicebill', $billing->id)}}" id="printinvoice" class="btn btn-warning">Print</a>
        </span>
    </div>
    <div style="clear:both;"></div>
    <a href="{{route('hotel_order.pos_invoice')}}" class="btn btn-primary">Back to POS</a>
    <div style="clear:both;"></div>
...
<script>
    $(document).ready(function(){
        ...
        $('#email').click( function(){
            ...
            if (email!=null){
                axios.post("{{route('hotel_order.billing_invoice.send_email', $billing->id)}}", {
                    'email': email
                })
                .then(response => {
