            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('hotel-kitchen.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method("POST")
                                    <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="kitchen_name" class="form-control"
                                                    placeholder="Enter Kitchen Name" value="{{ old('kitchen_name') }}">
                                                <p class="text-danger">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" name="remarks" class="form-control" value="{{ old('remarks') }}"
                                                    id="remarks">
                                                </textarea>
                                                <p class="text-danger">
