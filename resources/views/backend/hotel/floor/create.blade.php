            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('hotel-floor.store') }}" method="POST" enctype="multipart/form-data" id="form">
                                    @csrf
                                    @method("POST")
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="floor_name" class="form-control"
                                                    placeholder="Enter Floor Name" value="{{ old('floor_name') }}" tabindex="1">
                                                <p class="text-danger">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="floor_code" class="form-control"
                                                    placeholder="Enter Floor Code" value="{{ old('floor_code') }}"
                                                    id="floor_code" tabindex="2">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="">&nbsp;</label>
                                                <button type="submit" class="btn btn-primary btn-sm" tabindex="3">Save</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
