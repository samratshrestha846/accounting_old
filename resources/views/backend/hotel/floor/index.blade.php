        ...
        <div class="sec-header">
            <div class="container-fluid">
                <div class="sec-header-wrap">
                    <h1>Hotel Floors </h1>
                    <div class="btn-bulk">
                        @can('hotel-floor-create')
                            <a href="{{ route('hotel-floor.create') }}" class="global-btn">Add New Floor</a>
                        @endcan
                    </div>
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                            ...
                            <div class="col-md-12 table-responsive mt">
                                        ...
                                        @forelse ($floors as $floor)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-bulk">
                                                        @can('hotel-floor-create')
                                                            <a href='{{ route('hotel-floor.edit', $floor->id) }}'
                                                                class='edit btn btn-primary icon-btn btn-sm' title='Edit'><i
                                                                    class='fa fa-edit'></i></a>
                                                        @endcan
                                                        @can('hotel-floor-delete')
                                                            <form action='{{ route('hotel-floor.destroy', $floor->id) }}'
                                ...
                                <div class="mt-3">
                                    <div class="position row">
                                        <div class="col-md-8">
                                            <p class="text-sm">
                                                Showing <strong>{{ $floors->firstItem() }}</strong> to
                                                <strong>{{ $floors->lastItem() }} </strong> of <strong>
                                                    {{ $floors->total() }}</strong>
                                                entries
                                        ...
                                        <div class="col-md-4">
                                            <span class="pagination-sm m-0 float-right">{{ $floors->links() }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
