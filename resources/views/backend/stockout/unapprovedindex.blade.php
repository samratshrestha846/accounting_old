        ...
        <div class="sec-header">
            <div class="container-fluid">
                <div class="sec-header-wrap">
                    <h1>All Unapproved Stock Outs</h1>
                    <div class="btn-bulk">
                        <a href="{{ route('stockout.create') }}" class="global-btn">Create Stock Out</a>
                        <a href="{{ route('stockout.index') }}" class="global-btn">Approved Stock Out</a>
                    </div>
                    <!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <h2>All Unapproved Stock Out</h2>
                    </div>
                    <div class="card-body">
                        <div class="ibox">
                                            ...
                                            <div class="table-responsive mt noscroll">
                                                <table class="table table-bordered data-table text-center">
                                                    ...
                                                    <tbody>
                                                                ...
                                                                <td class="text-nowrap">
                                                                    <div class="btn-bulk">
                                                                        ...
                                                                        $btn = "<a href='$showurl' class='edit btn btn-primary icon-btn btn-sm'  data-toggle='tooltip' data-placement='top' title='View'><i class='fa fa-eye'></i></a>
                                                                                <a href='$approveurl' class='edit btn btn-secondary icon-btn btn-sm' title='Approve'><i class='far fa-thumbs-up'></i></a>
                                                                                    ";
                                                        ...
                                                        @empty
                                                            <tr><td colspan="7">No stockouts yet.</td></tr>
                                                        @endforelse
                                                    </tbody>
                                                </table>
                                                <div class="mt-3">
