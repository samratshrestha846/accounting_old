                ...
                <div class="row mb-2">
                    ...
                    {{-- <div class="col-md-12">
                        <div class="btn-bulk" style="margin-top:10px;">
                            <a href="{{ route('product.create') }}" class="btn btn-primary btn-sm">Create New Item</a>
                            <a href="{{ route('damaged_products.create') }}" class="btn btn-success btn-sm">Entry Damaged
                                Product</a> @if ($currentcomp->company->is_importer == 1) <a href="#" data-toggle='modal' data-target='#upload_csv' data-toggle='tooltip' data-placement='top' class="btn btn-primary btn-sm" title="Upload Product from CSV">Upload CSV(Product Upload)</a> <a href="#" data-toggle='modal' data-target='#update_csv' data-toggle='tooltip' data-placement='top' class="btn btn-primary btn-sm" title="Update Product from CSV">Upload CSV(For Product update)</a> @else <a href="#" data-toggle='modal' data-target='#upload_csv_non_importer' data-toggle='tooltip' data-placement='top' class="btn btn-primary btn-sm" title="Upload Product from CSV">Upload CSV(Product Upload)</a> <a href="#" data-toggle='modal' data-target='#update_csv_non_importer' data-toggle='tooltip' data-placement='top' class="btn btn-primary btn-sm" title="Update Product from CSV">Upload CSV(For Product update)</a> @endif
                        </div>
                    </div> --}}
                    <!-- /.col -->
                </div><!-- /.row -->
                ...
                <div class="ibox">
                    <div class="row ibox-body">
                        <div class="col-sm-12 col-md-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h1 class="text-center">Out of Stock Product By Godown</h1>
                                    <hr>
                                    {{-- <div class="col-md-12 ">
