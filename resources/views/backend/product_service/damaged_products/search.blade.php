        ...
        <div class="sec-header">
            <div class="container-fluid">
                <div class="sec-header-wrap">
                    <h1>Search Damaged Products </h1>
                    <div class="btn-bulk">
                        <a href="{{ route('damaged_products.create') }}" class="global-btn">Entry Damaged Products</a>
                                    ...
                                    <div class="table-responsive mt">
                                        <table class="table table-bordered data-table text-center">
                                            ...
                                            <tbody>
                                                @forelse ($damagedproducts as $damagedproduct)
                                                    <tr>
                                                        <td class="text-nowrap">
                                                            <a href="{{ Storage::disk('uploads')->url($damagedproduct->document) }}" target="_blank"><img src="{{ Storage::disk('uploads')->url($damagedproduct->document) }}" alt="{{ $damagedproduct->product->product_name }}" style="max-height: 100px;"></a>
                                                        </td>
                                                        <td class="text-nowrap">
                                                        ...
                                                        <td class="text-nowrap" style="width: 120px;">
                                                            <div class="btn-bulk justify-content-center">
                                                                ...
                                                                $btn = "<a href='$editurl' class='edit btn btn-primary icon-btn btn-sm' title='Edit'><i class='fa fa-edit'></i></a>
                                                                                                                                                                                                                                                                                                                                <button type='button' class='btn btn-secondary btn-sm' data-toggle='modal' data-target='#deleteproduct$damagedproduct->id' data-toggle='tooltip' data-placement='top' title='Delete'><i class='fa fa-trash'></i></button>
                                                                                                                                                                                                                                                                                                                                <!-- Modal -->
                                                ...
                                                @empty
                                                    <tr><td colspan="6">No products damaged.</td></tr>
                                                @endforelse
                                            </tbody>
                                        </table>
                                        <div class="mt-3">
