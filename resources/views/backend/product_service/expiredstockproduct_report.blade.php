    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-10">
                        <h1 class="m-0">Expired Stock Products</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-2">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('product.index') }}">Products</a></li>
                            <li class="breadcrumb-item active">Expired Stock Products</li>
                        </ol>
                    </div>
                    <!-- /.col -->
                </div><!-- /.row -->
                ...
                <div class="ibox">
                    <div class="row ibox-body">
                        <div class="col-sm-12 col-md-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h1 class="text-center">Expired Stock Product By Godown</h1>
                                    <hr>
                                    {{-- <div class="col-md-12 ">
