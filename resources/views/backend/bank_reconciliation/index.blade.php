                            ...
                            <div class="table-responsive mt noscroll">
                                <table class="table table-bordered data-table text-center global-table">
                                    ...
                                    <tbody>
                                                ...
                                                <td class="text-nowrap">
                                                    <div class="btn-bulk">
                                                        ...
                                                        if ($reconciliation->cheque_cashed_date == null) {
                                                            $btn = "
                                                                                                                                                                                                                                                                                                                                                                                                            <button type='button' class='btn btn-primary icon-btn btn-sm' data-toggle='modal' data-target='#entercashedoutDate' data-toggle='tooltip' data-placement='top' title='Enter Cashed Out'><i class='fa fa-edit'></i></button>
                                                                                                                                                                                                                                                                                                                                                                                                            <a href='$editurl' class='edit btn btn-secondary icon-btn btn-sm' title='Show'><i class='fa fa-eye'></i></a>
                                                                                                                                                                                                                                                                                                                                                                                                            <button type='button' class='btn btn-primary icon-btn btn-sm' data-toggle='modal' data-target='#deletechild$reconciliation->id' data-toggle='tooltip' data-placement='top' title='Delete'><i class='fa fa-trash'></i></button>
                                                                                                                                                                                                                                                                                                                                                                                                            <!-- Modal -->
                                                                                                                                                                                                                                                                                                                                                                                                                <div class='modal fade text-left' id='entercashedoutDate' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel' aria-hidden='true'>
                                        ...
                                        @empty
                                            <tr><td colspan="9">No statements yet.</td></tr>
                                        @endforelse
                                    </tbody>
                                </table>
                                <div class="mt-3">
