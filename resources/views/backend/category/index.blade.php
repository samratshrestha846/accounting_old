    ...
    <div class="sec-header">
        <div class="container-fluid">
            <div class="sec-header-wrap">
                <h1>Category </h1>
                <div class="btn-bulk">
                    <a href="{{ route('category.create') }}" class="global-btn">Add New Category</a>
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-body card-format" >
                    ...
                    <ol class="sortable" style="padding:0;">
                        ...
                        <li id="menuItem_{{ $category->id }}">
                            <div class="menu-handle d-flex justify-content-between">
                                ...
                                <div class="menu-options btn-group">
                                    ...
                                    <button type="button" class="btn btn-sm btn-secondary icon-btn" data-toggle="modal"
                                        data-target="#deletionservice{{ $category->id }}" data-toggle="tooltip"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type='button' class='btn btn-danger btn-sm' data-toggle='modal'
                                                data-target='#deletechild$category->id' data-toggle='tooltip'
                                                data-placement='top' title='Delete'><i class='fa fa-trash'></i></button>
                                            <!-- Modal -->
                                            <div class='modal fade text-left' id='deletechild$category->id'
                                                tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel'
                                                aria-hidden='true'>
                                                <div class='modal-dialog' role='document'>
                                                    <div class='modal-content'>
