  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-9">
            <h1 class="m-0">Search Category <a href="{{ route('category.create') }}" class="btn btn-sm btn-primary">Add New Category</a></h1>
          </div><!-- /.col -->
          <div class="col-sm-3">
                    ...
                    <div class="col-md-12 table-responsive">
                        <table class="table table-bordered data-table text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><img src="{{$category->category_image == "noimage.jpg" ? Storage::disk('uploads')->url('noimage.jpg') : Storage::disk('uploads')->url($category->category_image)}}" alt="{{$category->category_name}}" style="max-height:100px;"></td>
