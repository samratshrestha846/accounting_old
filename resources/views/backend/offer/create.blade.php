                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="offer_start_date_nepali"
                                                        ...
                                                        value="{{ old('offer_start_date_nepali', $nepali_today) }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="offer_start_date_english" id="english"
                                                        class="form-control" value="{{ old('offer_start_date_english', $today) }}"
                                                        readonly="readonly">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="offer_end_date_nepali"
                                                        ...
                                                        value="{{ old('offer_end_date_nepali', $nepali_today) }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="offer_end_date_english" id="englishEnd"
                                                        class="form-control" value="{{ old('offer_end_date_english', $today) }}"
                                                        readonly="readonly">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="minimun_price_range" class="form-control"
                                                        ...
                                                        value="{{ @old('minimun_price_range') }}" step="any">
                                                    <p class="text-danger">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="maximum_price_range" class="form-control"
                                                        placeholder="Amount in Rs."
                                                        value="{{ @old('maximum_price_range') }}" step="any">
                                                    <p class="text-danger">
