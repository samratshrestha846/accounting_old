...
class CreateSuspendedSaleAction {
    ...
    public function execute(User $suspendedUser, StoreSuspendSaleRequest $request): SuspendedBill
    {
        DB::beginTransaction();
        try {
            ...
            $suspendedBill = SuspendedBill::create([
