...
class HotelKitchenUpdateRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        $kitchenId = $this->hotel_kitchen->id;
        ...
        return [
            ...
            'kitchen_name' => [
                'required',
                Rule::unique('hotel_kitchens', 'kitchen_name')->ignore($kitchenId)->where(function ($query) use ($currentCompany) {
                    return $query->where(['company_id' => $currentCompany->company_id, 'branch_id' => $currentCompany->branch_id]);
                })
            ],
