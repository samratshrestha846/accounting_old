    ...
    public function rules()
    {
        ...
        return [
            'room_name' => [
                ...
                'string',
                'max:255',
                Rule::unique('hotel_rooms','name')->ignore($roomId)->where(function ($query) use($currentCompany) {
            ...
            'room_code' => [
                ...
                'string',
                'max:255',
                Rule::unique('hotel_rooms','code')->ignore($roomId)->where(function ($query) use($currentCompany) {
