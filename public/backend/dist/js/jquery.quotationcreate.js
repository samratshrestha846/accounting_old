...
// var selected_filter_array = window.selected_filter_array;
...
Invoice.prototype = {
    ...
    //         if(clientratepercenttype == 'undefined'){
    //             spanrate = row.find($.opt.item).find(":selected").data("rate");
    //             row.find($.opt.spanrate).html(datarate);
    //         }else{
    //             clientratepercent = jQuery($.opt.client).find(':selected').data('dealer_percent');
    //             spanrate = row.find($.opt.item).find(":selected").data("rate");
    //             spanrate_after_dealer_percent = spanrate - spanrate * clientratepercent/100;
    //             row.find($.opt.spanrate).html(spanrate_after_dealer_percent);
    //         }
    //     })
    //     return 1;
    // },
    ...
    getdata: function () {
        jQuery($.opt.parentClass).each(function (i) {
            ...
            row.find($.opt.spanunit).val(dataunit);
            //data Unit
            dataunit = row.find($.opt.item).find(":selected").data("priunit");
            row.find($.opt.unit).html(dataunit);
            //data Stock
    ...
    newRow: function () {
        // var selected_filter_array = jQuery($.opt.selectedFilter).val();
        ...
        $(function() {
            ...
            $('.item').change(function() {
               ...
               let avalProduct = window.avaliableProducts
        ...
        // var selected_filter_array = window.selected_filter_array;
        // var selected_filter_array = $('#SelectedFilter').val();
        // console.log(selected_filter_array);
        ...
        <input class="form-control unit" placeholder="Unit" type="hidden" name="unit[]" readonly>
