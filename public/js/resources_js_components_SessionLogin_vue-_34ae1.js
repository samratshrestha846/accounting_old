"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_SessionLogin_vue-_34ae1"],{
  ...
  methods: {
    resetTimerSession: function resetTimerSession() {
      ...
      this.timeout = setTimeout(function () {
        console.log("i am logout"); // this.session = true;
    ...
    login: function login() {
      axios.post('/login', this.form).then(function (response) {})["catch"](function (error) {});
    }
  }
});
