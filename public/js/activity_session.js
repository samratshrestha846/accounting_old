...
/* harmony import */ var _components_Ui_LoadingButton__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @/components/Ui/LoadingButton */ "./resources/js/components/Ui/LoadingButton.vue");
/* harmony import */ var _services_ProductSaleService__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @/services/ProductSaleService */ "./resources/js/services/ProductSaleService.js");
/* harmony import */ var _enums_ProductPurchase_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @/enums/ProductPurchase.js */ "./resources/js/enums/ProductPurchase.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  components: {
    ...
    LoadingButton: _components_Ui_LoadingButton__WEBPACK_IMPORTED_MODULE_2__["default"]
  },
  data: function data() {
    return {
      loadingData: false,
  ...
  computed: {
    CanDiscountIndividualProductItem: function CanDiscountIndividualProductItem() {
      return true;
    },
    CanTaxIndividualProductItem: function CanTaxIndividualProductItem() {
      return !this.form.allTaxType && !this.form.allTax ? true : false;
    },
    canTaxBulkSalesItem: function canTaxBulkSalesItem() {
      return this.form.allTax && this.form.allTaxType ? true : false;
    },
    canDiscountBulkSalesItem: function canDiscountBulkSalesItem() {
      return this.form.allDiscountType && this.form.allDiscount ? true : false;
    },
    payableAmount: function payableAmount() {
      var payableAmount = this.totalSalesProductPrice.gross_total - Number(this.form.payment_amount);
      return payableAmount < 0 ? 0 : payableAmount.toFixed(2);
    },
    changeAmount: function changeAmount() {
      var grossTotal = this.totalSalesProductPrice.gross_total;
      if (!this.form.payment_amount) return 0;
      if (this.form.payment_amount <= grossTotal) return 0;
      return Number(this.form.payment_amount - grossTotal).toFixed(2);
    },
    totalSalesProductPrice: function totalSalesProductPrice() {
      var _this = this,
          _this$form$allTaxType;

      var bulkDiscount = 0;
      var bulkTax = 0;
      var totalTax = 0;
      var totalDiscount = 0;
      var totalCost = Number(this.orderitem.sub_total);
      var totalServiceCharge = totalCost * Number(this.form.service_charge || 0) / 100;
      var totalCabinCharge = this.orderitem.is_cabin ? Number(this.orderitem.cabin_charge || 0) : 0;

      if (this.CanTaxIndividualProductItem) {
        totalTax = this.salesItemsList.reduce(function (a, b) {
          return +a + +b.total_tax;
        }, 0);
      } else if (this.canTaxBulkSalesItem) {
        var tax = this.taxes.find(function (item) {
          return item.id === _this.form.allTax;
        });
        totalTax = (tax === null || tax === void 0 ? void 0 : tax.percent) * totalCost / 100;
        bulkTax = totalTax;
      }

      if (this.CanDiscountIndividualProductItem) {
        totalDiscount = this.salesItemsList.reduce(function (a, b) {
          return +a + +b.total_discount;
        }, 0);
      }
      ...
      return {
        ...
        gross_total: ((_this$form$allTaxType = this.form.allTaxType) === null || _this$form$allTaxType === void 0 ? void 0 : _this$form$allTaxType.toLowerCase()) === "exclusive" ? totalCost + totalServiceCharge + totalTax - bulkDiscount + totalCabinCharge : totalCost + totalServiceCharge - bulkDiscount + totalCabinCharge
      };
    },
    salesItemsList: function salesItemsList() {
      var items = [];
      var productSaleService = new _services_ProductSaleService__WEBPACK_IMPORTED_MODULE_3__["default"](this.selected.products);
  ...
  methods: {
    ...
    findOrderItem: function findOrderItem() {
      var _this2 = this;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return _this2.$store.dispatch('FIND_RESTAURANT_ORDER_ITEM', {
                  order_id: _this2.order_id
                }).then(function (response) {
                  _this2.orderitem = response.data.data;

                  _this2.initData();

                  _this2.orderitem.order_items.forEach(function (item) {
                    _this2.addSelectedProductItem({
    ...
    addSelectedProductItem: function addSelectedProductItem(product) {
      ...
      var primaryStock = product.primary_stock;
      var secondaryStock = product.secondary_stock;
      var purchaseType = product.purchase_type || _enums_ProductPurchase_js__WEBPACK_IMPORTED_MODULE_4__.primaryUnit;
      var units = []; //if the product has zero primary stock then check for secondary stock
      ...
      if (product.primary_unit) {
        units.push({
          purchase_type: _enums_ProductPurchase_js__WEBPACK_IMPORTED_MODULE_4__.primaryUnit,
      ...
      var selectedProduct = this.selected.products.find(function (value) {
      ...
      totalQuantity = selectedProduct ? selectedProduct.quantity + 1 : totalQuantity; //if the product already exist in the selected product item then update that product quantity & pruchase type
    ...
    actionPayment: function actionPayment() {
      var _this3 = this;
      ...
      axios.post('/api/hotel/order/fooditems/' + this.orderitem.id + '/payment', payload).then(function (response) {
        _this3.submitLoading = false;

        _this3.closeModal();

        _this3.$emit('success', response.data.data);

        window.location.href = '/order/billing/' + response.data.data.id + '/view-invoice';
      })["catch"](function (error) {
        if (error.response.status === 422) {
          _this3.form.errors = error.response.data.errors;
        } else {
          _this3.errorMessage = "Something went wrong. Please reload page1111...";
        }
      })["finally"](function () {
        _this3.submitLoading = false;
      });
...
/* harmony import */ var _modules_product_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/product.js */ "./resources/js/Store/modules/product.js");
/* harmony import */ var _modules_category__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/category */ "./resources/js/Store/modules/category.js");
/* harmony import */ var _modules_customer__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/customer */ "./resources/js/Store/modules/customer.js");
/* harmony import */ var _modules_suspend_sale__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/suspend_sale */ "./resources/js/Store/modules/suspend_sale.js");
/* harmony import */ var _modules_cart_item_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/cart_item.js */ "./resources/js/Store/modules/cart_item.js");
/* harmony import */ var _modules_godown_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/godown.js */ "./resources/js/Store/modules/godown.js");
/* harmony import */ var _modules_sales_report_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/sales_report.js */ "./resources/js/Store/modules/sales_report.js");
/* harmony import */ var _modules_restaurant_food_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/restaurant_food.js */ "./resources/js/Store/modules/restaurant_food.js");
/* harmony import */ var _modules_restaurant_table_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/restaurant_table.js */ "./resources/js/Store/modules/restaurant_table.js");
/* harmony import */ var _modules_restaurant_order_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/restaurant_order.js */ "./resources/js/Store/modules/restaurant_order.js");
/* harmony import */ var _modules_restaurant_billing_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/restaurant_billing.js */ "./resources/js/Store/modules/restaurant_billing.js");
/* harmony import */ var _modules_restaurant_floor_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./modules/restaurant_floor.js */ "./resources/js/Store/modules/restaurant_floor.js");
/* harmony import */ var _modules_restaurant_room_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./modules/restaurant_room.js */ "./resources/js/Store/modules/restaurant_room.js");
/* harmony import */ var _modules_restaurant_delivery_partners_js__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./modules/restaurant_delivery_partners.js */ "./resources/js/Store/modules/restaurant_delivery_partners.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (new vuex__WEBPACK_IMPORTED_MODULE_1__["default"].Store({
  ...
  mutations: {
    SET_DISTRICT_LIST: function SET_DISTRICT_LIST(state, payload) {
      state.districts = payload;
    },
    SET_PROVINCE_LIST: function SET_PROVINCE_LIST(state, payload) {
      state.provinces = payload;
    }
  },
  actions: {
    GET_DISTRICT_LIST: function GET_DISTRICT_LIST(context, payload) {
      return new Promise(function (resolve, reject) {
        axios.get("/api/districts", payload).then(function (response) {
    ...
    GET_PROVINCE_LIST: function GET_PROVINCE_LIST(context, payload) {
      return new Promise(function (resolve, reject) {
        axios.get("/api/provinces", payload).then(function (response) {
  ...
  modules: {
    ...
    product: _modules_product_js__WEBPACK_IMPORTED_MODULE_3__["default"],
    category: _modules_category__WEBPACK_IMPORTED_MODULE_4__["default"],
    customer: _modules_customer__WEBPACK_IMPORTED_MODULE_5__["default"],
    suspend_sale: _modules_suspend_sale__WEBPACK_IMPORTED_MODULE_6__["default"],
    cart_item: _modules_cart_item_js__WEBPACK_IMPORTED_MODULE_7__["default"],
    godown: _modules_godown_js__WEBPACK_IMPORTED_MODULE_8__["default"],
    sales_report: _modules_sales_report_js__WEBPACK_IMPORTED_MODULE_9__["default"],
    restaurant_food: _modules_restaurant_food_js__WEBPACK_IMPORTED_MODULE_10__["default"],
    restaurant_table: _modules_restaurant_table_js__WEBPACK_IMPORTED_MODULE_11__["default"],
    restaurant_order: _modules_restaurant_order_js__WEBPACK_IMPORTED_MODULE_12__["default"],
    restaurant_billing: _modules_restaurant_billing_js__WEBPACK_IMPORTED_MODULE_13__["default"],
    restaurant_floor: _modules_restaurant_floor_js__WEBPACK_IMPORTED_MODULE_14__["default"],
    restaurant_room: _modules_restaurant_room_js__WEBPACK_IMPORTED_MODULE_15__["default"],
    restaurant_delivery_partner: _modules_restaurant_delivery_partners_js__WEBPACK_IMPORTED_MODULE_16__["default"]
  }
}));
...
var actions = {
  LOGOUT: function LOGOUT(context, payload) {
    return new Promise(function (resolve, reject) {
      axios__WEBPACK_IMPORTED_MODULE_0___default().post("/logout", payload).then(function (response) {
        resolve(response);
      })["catch"](function (errors) {
        return reject(errors);
      });
...
/***/ "./resources/js/Store/modules/cart_item.js":
/*!*************************************************!*\
  !*** ./resources/js/Store/modules/cart_item.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var actions = {
  CREATE_SALE_CART_ITEM: function CREATE_SALE_CART_ITEM(context, payload) {
    return new Promise(function (resolve, reject) {
      axios__WEBPACK_IMPORTED_MODULE_0___default().post("/api/products/cartitems", payload).then(function (response) {
        resolve(response);
      })["catch"](function (errors) {
        return reject(errors);
      });
...
var mutations = {
  SET_CART_ITEM_LIST: function SET_CART_ITEM_LIST(state, payload) {
...
var actions = {
  GET_CATEGORY_LIST: function GET_CATEGORY_LIST(context, payload) {
    return new Promise(function (resolve, reject) {
      axios__WEBPACK_IMPORTED_MODULE_0___default().get("/apicategory", payload).then(function (response) {
...
var mutations = {
  SET_CATEGORY_LIST: function SET_CATEGORY_LIST(state, payload) {
...
var actions = {
  GET_CUSTOMER_LIST: function GET_CUSTOMER_LIST(context, payload) {
    return new Promise(function (resolve, reject) {
      axios__WEBPACK_IMPORTED_MODULE_0___default().get("/api/customers", payload).then(function (response) {
  ...
  CREATE_CUSTOMER: function CREATE_CUSTOMER(context, payload) {
    return new Promise(function (resolve, reject) {
      axios__WEBPACK_IMPORTED_MODULE_0___default().post("/api/customers", payload).then(function (response) {
        // context.commit("SET_CATEGORY_LIST", response.data);
        resolve(response);
      })["catch"](function (errors) {
        return reject(errors);
...
var mutations = {
  SET_CUSTOMER_LIST: function SET_CUSTOMER_LIST(state, payload) {
...
/***/ "./resources/js/Store/modules/godown.js":
/*!**********************************************!*\
  !*** ./resources/js/Store/modules/godown.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var actions = {
  GET_GODOWN_LIST: function GET_GODOWN_LIST(context, payload) {
    return new Promise(function (resolve, reject) {
      axios__WEBPACK_IMPORTED_MODULE_0___default().get("/api/godowns", payload).then(function (response) {
...
var mutations = {
  SET_GODOWN_LIST: function SET_GODOWN_LIST(state, payload) {
    state.godowns = payload;
  }
};
var getters = {
  godowns: function godowns(state) {
...
var actions = {
  GET_POS_PRODUCT_LIST_BY_OUTLET_ID: function GET_POS_PRODUCT_LIST_BY_OUTLET_ID(context, payload) {
    return new Promise(function (resolve, reject) {
      axios__WEBPACK_IMPORTED_MODULE_0___default().get('/api/pos/outlets/' + payload.outlet_id + '/products', payload).then(function (response) {
  ...
  FIND_POS_PRODUCT_BY_OUTLET_ID_AND_PRODUCT_CODE: function FIND_POS_PRODUCT_BY_OUTLET_ID_AND_PRODUCT_CODE(context, payload) {
    return new Promise(function (resolve, reject) {
      axios__WEBPACK_IMPORTED_MODULE_0___default().get('/api/pos/outlets/' + payload.outlet_id + '/products/' + payload.product_code, payload).then(function (response) {
        context.commit("SET_PRODUCT_LIST", response.data.data);
        resolve(response);
      })["catch"](function (errors) {
        return reject(errors);
...
var mutations = {
  SET_PRODUCT_LIST: function SET_PRODUCT_LIST(state, payload) {
...
/***/ "./resources/js/Store/modules/restaurant_billing.js":
/*!**********************************************************!*\
  !*** ./resources/js/Store/modules/restaurant_billing.js ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var state = {};
var actions = {
  FIND_RESTAURANT_BILLING: function FIND_RESTAURANT_BILLING(context, billing_id) {
    return new Promise(function (resolve, reject) {
      axios__WEBPACK_IMPORTED_MODULE_0___default().get("/api/hotel/order/billings/" + billing_id).then(function (response) {
        resolve(response);
      })["catch"](function (errors) {
        return reject(errors);
      });
...
/***/ "./resources/js/Store/modules/restaurant_delivery_partners.js":
/*!********************************************************************!*\
  !*** ./resources/js/Store/modules/restaurant_delivery_partners.js ***!
  \********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var actions = {
  GET_RESTAURANT_DELIVERY_PARTNER_ITEM: function GET_RESTAURANT_DELIVERY_PARTNER_ITEM(context, payload) {
    return new Promise(function (resolve, reject) {
      axios__WEBPACK_IMPORTED_MODULE_0___default().get("/api/hotel/order/delivery_partners", payload).then(function (response) {
...
var mutations = {
  SET_RESTAURANT_DELIVERY_PARTNER_ITEM: function SET_RESTAURANT_DELIVERY_PARTNER_ITEM(state, payload) {
    state.restaurantDeliveryPartnerList = payload;
  }
};
var getters = {
  restaurantDeliveryPartnerList: function restaurantDeliveryPartnerList(state) {
    return state.restaurantDeliveryPartnerList;
  }
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  state: state,
...
/***/ "./resources/js/Store/modules/restaurant_floor.js":
/*!********************************************************!*\
  !*** ./resources/js/Store/modules/restaurant_floor.js ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var actions = {
  GET_RESTAURANT_FLOOR_ITEM: function GET_RESTAURANT_FLOOR_ITEM(context, payload) {
    return new Promise(function (resolve, reject) {
      axios__WEBPACK_IMPORTED_MODULE_0___default().get("/api/floors", payload).then(function (response) {
...
var mutations = {
  SET_RESTAURANT_FLOOR_ITEM: function SET_RESTAURANT_FLOOR_ITEM(state, payload) {
    state.floors = payload;
  }
};
var getters = {
  floors: function floors(state) {
    return state.floors;
  }
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
...
/***/ "./resources/js/Store/modules/restaurant_food.js":
/*!*******************************************************!*\
  !*** ./resources/js/Store/modules/restaurant_food.js ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var actions = {
  GET_RESTAURANT_FOOD_LIST: function GET_RESTAURANT_FOOD_LIST(context, payload) {
    return new Promise(function (resolve, reject) {
      axios__WEBPACK_IMPORTED_MODULE_0___default().get("/api/hotel/order/fooditems", payload).then(function (response) {
...
var mutations = {
  SET_RESTAURANT_FOOD_LIST: function SET_RESTAURANT_FOOD_LIST(state, payload) {
    state.restaurantFoodList = payload;
  }
};
var getters = {
  restaurantFoodList: function restaurantFoodList(state) {
    return state.restaurantFoodList;
  }
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  state: state,
...
/***/ "./resources/js/Store/modules/restaurant_order.js":
/*!********************************************************!*\
  !*** ./resources/js/Store/modules/restaurant_order.js ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ "./node_modules/axios/index.js");
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _enums_OrderItemStatus__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../enums/OrderItemStatus */ "./resources/js/enums/OrderItemStatus.js");
...
var actions = {
  CREATE_RESTAURANT_ORDER_ITEM: function CREATE_RESTAURANT_ORDER_ITEM(context, payload) {
    return new Promise(function (resolve, reject) {
      axios__WEBPACK_IMPORTED_MODULE_0___default().post("/api/hotel/order/fooditems/place", payload).then(function (response) {
        resolve(response);
      })["catch"](function (errors) {
        return reject(errors);
      });
  ...
  GET_RESTAURANT_ORDER_DETAIL: function GET_RESTAURANT_ORDER_DETAIL(context, payload) {
    return new Promise(function (resolve, reject) {
      axios__WEBPACK_IMPORTED_MODULE_0___default().get("/api/hotel/order/get_order_detail", payload).then(function (response) {
        resolve(response);
      })["catch"](function (errors) {
        return reject(errors);
      });
  ...
  GET_RESTAURANT_ORDER_ITEM: function GET_RESTAURANT_ORDER_ITEM(context, payload) {
    return new Promise(function (resolve, reject) {
      axios__WEBPACK_IMPORTED_MODULE_0___default().get("/api/hotel/order/orders", payload).then(function (response) {
        resolve(response);
      })["catch"](function (errors) {
        return reject(errors);
      });
  ...
  FIND_RESTAURANT_ORDER_ITEM: function FIND_RESTAURANT_ORDER_ITEM(context, payload) {
    return new Promise(function (resolve, reject) {
      axios__WEBPACK_IMPORTED_MODULE_0___default().get("/api/hotel/order/orders/" + payload.order_id, payload).then(function (response) {
        resolve(response);
      })["catch"](function (errors) {
        return reject(errors);
      });
  ...
  CANCEL_RESTAURANT_ORDER: function CANCEL_RESTAURANT_ORDER(context, payload) {
    return new Promise(function (resolve, reject) {
      axios__WEBPACK_IMPORTED_MODULE_0___default().post("/api/hotel/order/orders/" + payload.order_id + '/cancle', payload).then(function (response) {
        resolve(response);
      })["catch"](function (errors) {
        return reject(errors);
      });
  ...
  SUSPEND_RESTAURANT_ORDER: function SUSPEND_RESTAURANT_ORDER(context, payload) {
    return new Promise(function (resolve, reject) {
      axios__WEBPACK_IMPORTED_MODULE_0___default().post("/api/hotel/order/orders/" + payload.order_id + '/suspend', payload).then(function (response) {
        resolve(response);
      })["catch"](function (errors) {
        return reject(errors);
      });
  ...
  RESTORE_RESTAURANT_ORDER: function RESTORE_RESTAURANT_ORDER(context, payload) {
    return new Promise(function (resolve, reject) {
      axios__WEBPACK_IMPORTED_MODULE_0___default().post("/api/hotel/order/orders/" + payload.order_id + '/restore', payload).then(function (response) {
        resolve(response);
      })["catch"](function (errors) {
        return reject(errors);
      });
...
var mutations = {// SET_RESTAURANT_FOOD_LIST(state, payload) {
  //     state.restaurantFoodList = payload;
  // },
};
var getters = {// restaurantFoodList: state => state.restaurantFoodList,
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  state: state,
  actions: actions,
...
/***/ "./resources/js/Store/modules/restaurant_room.js":
/*!*******************************************************!*\
  !*** ./resources/js/Store/modules/restaurant_room.js ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var actions = {
  GET_RESTAURANT_ROOM_ITEM: function GET_RESTAURANT_ROOM_ITEM(context, payload) {
    return new Promise(function (resolve, reject) {
      axios__WEBPACK_IMPORTED_MODULE_0___default().get("/api/rooms", payload).then(function (response) {
...
var mutations = {
  SET_RESTAURANT_ROOM_ITEM: function SET_RESTAURANT_ROOM_ITEM(state, payload) {
    state.rooms = payload;
  }
};
var getters = {
...
/***/ "./resources/js/Store/modules/restaurant_table.js":
/*!********************************************************!*\
  !*** ./resources/js/Store/modules/restaurant_table.js ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var actions = {
  GET_RESTAURANT_TABLE_ITEM: function GET_RESTAURANT_TABLE_ITEM(context, payload) {
    return new Promise(function (resolve, reject) {
      axios__WEBPACK_IMPORTED_MODULE_0___default().get("/api/tables", payload).then(function (response) {
        resolve(response);
      })["catch"](function (errors) {
        return reject(errors);
      });
  ...
  GET_RESTAURANT_ORDER_TABLE_LIST: function GET_RESTAURANT_ORDER_TABLE_LIST(context, payload) {
    return new Promise(function (resolve, reject) {
      axios__WEBPACK_IMPORTED_MODULE_0___default().get("/api/hotel/order/tables", payload).then(function (response) {
...
var mutations = {
  SET_RESTAURANT_TABLE_LIST: function SET_RESTAURANT_TABLE_LIST(state, payload) {
    state.restaurantTableList = payload;
  }
};
var getters = {
  restaurantTableList: function restaurantTableList(state) {
    return state.restaurantTableList;
  }
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  state: state,
...
/***/ "./resources/js/Store/modules/sales_report.js":
/*!****************************************************!*\
  !*** ./resources/js/Store/modules/sales_report.js ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var state = {};
var actions = {
  GET_TODAY_SALES_REPORT: function GET_TODAY_SALES_REPORT(context, payload) {
    return new Promise(function (resolve, reject) {
      axios__WEBPACK_IMPORTED_MODULE_0___default().get('/api/outlets/' + payload.outlet_id + '/salesreports/today-sale', payload).then(function (response) {
        resolve(response);
      })["catch"](function (errors) {
        return reject(errors);
      });
...
/***/ "./resources/js/Store/modules/suspend_sale.js":
/*!****************************************************!*\
  !*** ./resources/js/Store/modules/suspend_sale.js ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var actions = {
  GET_SUSPENDED_PRODUCT_LIST: function GET_SUSPENDED_PRODUCT_LIST(context, payload) {
    return new Promise(function (resolve, reject) {
      axios__WEBPACK_IMPORTED_MODULE_0___default().get("/api/products/suspendedsales/" + payload.suspended_bill_id + "/suspendeditems", payload).then(function (response) {
  ...
  SUSPEND_SALE: function SUSPEND_SALE(context, payload) {
    return new Promise(function (resolve, reject) {
      axios__WEBPACK_IMPORTED_MODULE_0___default().post("/api/products/sales/suspends", payload).then(function (response) {
        // context.commit("SET_CATEGORY_LIST", response.data);
        resolve(response);
      })["catch"](function (errors) {
        return reject(errors);
  ...
  UPDATE_SUSPEND_SALE: function UPDATE_SUSPEND_SALE(context, payload) {
    return new Promise(function (resolve, reject) {
      axios__WEBPACK_IMPORTED_MODULE_0___default().patch("/api/products/suspendedsales/" + payload.suspended_bill_id, payload).then(function (response) {
        // context.commit("SET_CATEGORY_LIST", response.data);
        resolve(response);
      })["catch"](function (errors) {
        return reject(errors);
  ...
  DELETE_SUSPEND_PRODUCT_ITEM: function DELETE_SUSPEND_PRODUCT_ITEM(context, payload) {
    return new Promise(function (resolve, reject) {
      axios__WEBPACK_IMPORTED_MODULE_0___default()["delete"]("/api/products/suspendeditems/" + payload.suspended_bill_id, payload).then(function (response) {
        // context.commit("SET_CATEGORY_LIST", response.data);
        resolve(response);
      })["catch"](function (errors) {
        return reject(errors);
  ...
  CANCLE_SUSPEND_PRODUCT_SALE: function CANCLE_SUSPEND_PRODUCT_SALE(context, payload) {
    return new Promise(function (resolve, reject) {
      axios__WEBPACK_IMPORTED_MODULE_0___default().post("/api/products/suspendedsales/" + payload.suspended_bill_id + '/cancle', payload).then(function (response) {
        // context.commit("SET_CATEGORY_LIST", response.data);
        resolve(response);
      })["catch"](function (errors) {
        return reject(errors);
...
var mutations = {
  SET_SUSPENDED_SALE_PRODUCT_LIST: function SET_SUSPENDED_SALE_PRODUCT_LIST(state, payload) {
    state.suspendedSaleItems = payload;
  }
};
var getters = {
  suspendedSaleItems: function suspendedSaleItems(state) {
    return state.suspendedSaleItems;
  }
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  state: state,
...
/***/ "./resources/js/enums/OrderItemStatus.js":
/*!***********************************************!*\
  !*** ./resources/js/enums/OrderItemStatus.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "getStatusNameByValue": () => (/* binding */ getStatusNameByValue),
...
var getStatusNameByValue = function getStatusNameByValue(value) {
  var statusName = "-";
  if (!value) return statusName;
...
var statusList = [status.cancled, status.pending, status.served, status.suspended];


/***/ }),

/***/ "./resources/js/enums/ProductPurchase.js":
/*!***********************************************!*\
  !*** ./resources/js/enums/ProductPurchase.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "primaryUnit": () => (/* binding */ primaryUnit),
/* harmony export */   "secondaryUnit": () => (/* binding */ secondaryUnit)
/* harmony export */ });
var primaryUnit = "primary_unit";
var secondaryUnit = "secondary_unit";


/***/ }),

/***/ "./resources/js/services/ProductSaleService.js":
/*!*****************************************************!*\
  !*** ./resources/js/services/ProductSaleService.js ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ ProductSaleService)
/* harmony export */ });
/* harmony import */ var _enums_ProductPurchase_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @/enums/ProductPurchase.js */ "./resources/js/enums/ProductPurchase.js");
/* harmony import */ var _calculation__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./calculation */ "./resources/js/services/calculation.js");
...
var ProductSaleService = /*#__PURE__*/function () {
  function ProductSaleService(salesItems) {
    _classCallCheck(this, ProductSaleService);
  ...
  _createClass(ProductSaleService, [{
    key: "setTaxRate",
    value: function setTaxRate(taxType, taxRate) {
      this.taxType = taxType;
      this.taxRate = taxRate;
    }
  }, {
    key: "setDiscountRate",
    value: function setDiscountRate(discountType, discountValue) {
    ...
    value: function calculate() {
      ...
      var items = [];
      this.salesItems.forEach(function (product, index) {
        var _product$tax_type2;

        console.log("the purhcase type is ", product.purchase_type);
        var subTotal = product.purchase_type == _enums_ProductPurchase_js__WEBPACK_IMPORTED_MODULE_0__.primaryUnit ? product.product_price * product.quantity : product.secondary_unit_selling_price * product.quantity;
        var totalTax = 0;
        var totalDiscount = 0;
        var grossTotal = subTotal; //if individual sale item has discountValueand discountType

        if (product.value_discount && product.discount_type) {
          totalDiscount = (0,_calculation__WEBPACK_IMPORTED_MODULE_1__.calculateDiscountRate)(subTotal, product.discount_type.toLowerCase() || "", Number(product.value_discount));
        } //if sale item has taxValue and taxType without bulk tax


        if (!_this.hasBulkTax() && product.tax && product.tax_type) {
          var _product$tax_type, _product$tax;

          totalTax = (0,_calculation__WEBPACK_IMPORTED_MODULE_1__.calculateTaxRate)(subTotal, totalDiscount, ((_product$tax_type = product.tax_type) === null || _product$tax_type === void 0 ? void 0 : _product$tax_type.toLowerCase()) || '', Number((_product$tax = product.tax) === null || _product$tax === void 0 ? void 0 : _product$tax.percent));
        }
        ...
        items.push({
          ...
          purchase_unit: product.purchase_type == _enums_ProductPurchase_js__WEBPACK_IMPORTED_MODULE_0__.primaryUnit ? product.primary_unit : product.secondary_unit,
          units: product.units,
          ...
          sub_total: subTotal,
          gross_total: grossTotal > 0 ? grossTotal - totalDiscount + (((_product$tax_type2 = product.tax_type) === null || _product$tax_type2 === void 0 ? void 0 : _product$tax_type2.toLowerCase()) == "exclusive" ? totalTax : 0) : grossTotal
        });
      });
    ...
    key: "getBulkTax",
    value: function getBulkTax() {}
  }, {
    key: "getBulkDiscount",
    value: function getBulkDiscount() {}
  }, {
    key: "hasBulkTax",
    value: function hasBulkTax() {
...
/***/ "./resources/js/services/calculation.js":
/*!**********************************************!*\
  !*** ./resources/js/services/calculation.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "calculateTaxRate": () => (/* binding */ calculateTaxRate),
/* harmony export */   "calculateDiscountRate": () => (/* binding */ calculateDiscountRate)
/* harmony export */ });
var calculateTaxRate = function calculateTaxRate(subTotal, totalDiscount, taxType, taxValue) {
  var totalTax = 0;
...
var calculateDiscountRate = function calculateDiscountRate(subTotal, discountType, discountValue) {
  var totalDiscount = 0;
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _enums_OrderItemStatus__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../enums/OrderItemStatus */ "./resources/js/enums/OrderItemStatus.js");
...
var isNumber = function isNumber(evt) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  isNumber: isNumber,
  todayDate: todayDate,
  getStatusNameByValue: _enums_OrderItemStatus__WEBPACK_IMPORTED_MODULE_0__.getStatusNameByValue,
  statusList: _enums_OrderItemStatus__WEBPACK_IMPORTED_MODULE_0__.statusList
});
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _CreatePaymentModal_vue_vue_type_template_id_06fffd4c___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./CreatePaymentModal.vue?vue&type=template&id=06fffd4c& */ "./resources/js/Pages/Hotel/order_item/CreatePaymentModal.vue?vue&type=template&id=06fffd4c&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _CreatePaymentModal_vue_vue_type_template_id_06fffd4c___WEBPACK_IMPORTED_MODULE_0__.render,
  _CreatePaymentModal_vue_vue_type_template_id_06fffd4c___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/***/ "./resources/js/Pages/Hotel/order_item/CreatePaymentModal.vue?vue&type=template&id=06fffd4c&":
/*!***************************************************************************************************!*\
  !*** ./resources/js/Pages/Hotel/order_item/CreatePaymentModal.vue?vue&type=template&id=06fffd4c& ***!
  \***************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_CreatePaymentModal_vue_vue_type_template_id_06fffd4c___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_CreatePaymentModal_vue_vue_type_template_id_06fffd4c___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_CreatePaymentModal_vue_vue_type_template_id_06fffd4c___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./CreatePaymentModal.vue?vue&type=template&id=06fffd4c& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Pages/Hotel/order_item/CreatePaymentModal.vue?vue&type=template&id=06fffd4c&");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Pages/Hotel/order_item/CreatePaymentModal.vue?vue&type=template&id=06fffd4c&":
/*!******************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/Pages/Hotel/order_item/CreatePaymentModal.vue?vue&type=template&id=06fffd4c& ***!
  \******************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    ...
    "form",
    {
      on: {
        submit: function ($event) {
          $event.preventDefault()
          return _vm.actionPayment.apply(null, arguments)
        },
      },
    },
    [
                      ...
                      _c("div", { staticClass: "row text-left" }, [
                        _c("div", { staticClass: "col-md-8" }, [
                          _c("div", { staticClass: "row" }, [
                              ...
                              _c("div", { staticClass: "form-group" }, [
                                ...
                                _c(
                                    ...
                                    directives: [
                                      {
                                        name: "model",
                                        rawName: "v-model",
                                        value: _vm.form.allDiscountType,
                                        expression: "form.allDiscountType",
                                      },
                                    ],
                                  ...
                                  [
                                    _c("option", [_vm._v("------")]),
                                    _vm._v(" "),
                                    _vm._l(_vm.discount_types, function (type) {
                                      return _c(
                                        "option",
                                        { domProps: { value: type } },
                                        [_vm._v(_vm._s(type))]
                                  ...
                                  directives: [
                                    {
                                      name: "model",
                                      rawName: "v-model",
                                      value: _vm.form.allDiscount,
                                      expression: "form.allDiscount",
                                    },
                                  ],
                                  staticClass: "form-control",
                                  domProps: { value: _vm.form.allDiscount },
                                  on: {
                                    keypress: function ($event) {
                                      return _vm.$filters.isNumber($event)
                                    },
                              ...
                              _c("div", { staticClass: "form-group" }, [
                                ...
                                _c(
                                    ...
                                    directives: [
                                      {
                                        name: "model",
                                        rawName: "v-model",
                                        value: _vm.form.allTaxType,
                                        expression: "form.allTaxType",
                                      },
                                    ],
                                    staticClass: "form-control",
                                    on: {
                                  ...
                                  [
                                    _c("option", [_vm._v("------")]),
                                    _vm._v(" "),
                                    _vm._l(_vm.tax_types, function (type) {
                                      return _c(
                                        "option",
                                        { domProps: { value: type } },
                                        [_vm._v(_vm._s(type))]
                                    ...
                                    directives: [
                                      {
                                        name: "model",
                                        rawName: "v-model",
                                        value: _vm.form.allTax,
                                        expression: "form.allTax",
                                      },
                                    ],
                                    staticClass: "form-control",
                                    on: {
                            ...
                            _vm._v(" "),
                            _vm.orderitem && _vm.orderitem.is_cabin
                              ? _c("div", { staticClass: "col-12 row" }, [
                                  _c("div", { staticClass: "col-md-6" }, [
                                    _c("div", { staticClass: "form-group" }, [
                                      _c("label", [_vm._v("Cabin Charge")]),
                                      _vm._v(" "),
                                      _c("input", {
                                        staticClass: "form-control",
                                        attrs: { readonly: "" },
                            ...
                            _c("div", { staticClass: "col-md-6" }, [
                              _c("div", { staticClass: "form-group" }, [
                                    ...
                                    _vm._l(
                                      ...
                                      function (paymentType) {
                                        return _c(
                                          "option",
                                          {
                                            domProps: { value: paymentType.id },
                                          },
                                          [
                                            _vm._v(
                                              _vm._s(paymentType.payment_mode)
                                            ),
                                          ]
                                        )
                                      }
                                ...
                                _vm._v(" "),
                                _vm.form.errors && _vm.form.errors.payment_mode
                                  ? _c("p", { staticClass: "text-danger" }, [
                                      _vm._v(
                                        "\n                                        " +
                                          _vm._s(
                                            _vm.form.errors.payment_mode[0]
                                          ) +
                                          "\n                                    "
                                      ),
                                    ])
                            ...
                            _c("div", { staticClass: "col-md-6" }, [
                              _c("div", { staticClass: "form-group" }, [
                                ...
                                _c("input", {
                                  ...
                                  staticClass: "form-control",
                                  domProps: { value: _vm.form.payment_amount },
                                  on: {
                                    keypress: function ($event) {
                                      return _vm.$filters.isNumber($event)
                                    },
                                ...
                                _vm._v(" "),
                                _vm.form.errors &&
                                _vm.form.errors.payment_amount
                                  ? _c("p", { staticClass: "text-danger" }, [
                                      _vm._v(
                                        "\n                                        " +
                                          _vm._s(
                                            _vm.form.errors.payment_amount[0]
                                          ) +
                                          "\n                                    "
                                      ),
                                    ])
                          ...
                          _c("table", { staticClass: "table table-bordered" }, [
                            _c("tbody", [
                              _c("tr", [
                                ...
                                _vm._v(" "),
                                _c("td", [_vm._v(_vm._s(_vm.sub_total))]),
                              ]),
                              _vm._v(" "),
                              _c("tr", [
                                ...
                                _c("td", [
                                  _vm._v(
                                    _vm._s(
                                      _vm.totalSalesProductPrice.gross_total.toFixed(
                                        2
                                      )
                                    )
                                  ),
                              ...
                              _c("tr", [
                                ...
                                _vm._v(" "),
                                _c("td", [_vm._v(_vm._s(_vm.payableAmount))]),
                              ]),
                              _vm._v(" "),
                              _c("tr", [
                                _c("td", [_vm._v("Change")]),
                                _vm._v(" "),
                                _c("td", [_vm._v(_vm._s(_vm.changeAmount))]),
                              ]),
                            ]),
                          ]),
                        ]),
                        ...
                        _c(
                          ...
                          [
                            _c("LoadingButton", {
                              staticClass: "btn btn-primary w-auto float-right",
                              attrs: {
                                type: "submit",
...
"use strict";
/*!******************************************!*\
  !*** ./resources/js/activity_session.js ***!
  \******************************************/
__webpack_require__.r(__webpack_exports__);
...
/* harmony import */ var _services_filters__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./services/filters */ "./resources/js/services/filters.js");

 //sweetalert



vue__WEBPACK_IMPORTED_MODULE_3__["default"].use((vue_sweetalert2__WEBPACK_IMPORTED_MODULE_1___default())); //vue toast notification



vue__WEBPACK_IMPORTED_MODULE_3__["default"].use((vue_toast_notification__WEBPACK_IMPORTED_MODULE_4___default()));
vue__WEBPACK_IMPORTED_MODULE_3__["default"].component('make-payment-modal', (__webpack_require__(/*! ./Pages/Hotel/order_item/CreatePaymentModal */ "./resources/js/Pages/Hotel/order_item/CreatePaymentModal.vue")["default"]));
var app = new vue__WEBPACK_IMPORTED_MODULE_3__["default"]({
  ...
  methods: {
    resetTimerSession: function resetTimerSession() {
      ...
      var self = this; // console.log("Session activity loading");
...
vue__WEBPACK_IMPORTED_MODULE_3__["default"].prototype.$filters = _services_filters__WEBPACK_IMPORTED_MODULE_6__["default"];
})();
